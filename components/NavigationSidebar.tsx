  ...
  const navSections: NavSection[] = [
    {
      ...
      items: [
        ...
        { icon: <MessageSquarePlus size={iconSize} />, label: "My Feedback" },
    ...
    },
    {
      ...
      items: [
        ...
        { icon: <Award size={iconSize} />, label: "Performance Mgmt" },
    ...
    },
    {
      ...
      items: [
        ...
        { icon: <CircleDollarSign size={iconSize} />, label: "Accounts" },
        { icon: <Landmark size={iconSize} />, label: "Banking Management" },
        { icon: <Files size={iconSize} />, label: "Summary" },
        { icon: <Package size={iconSize} />, label: "Asset Management" },
        { icon: <ShieldPlus size={iconSize} />, label: "Depreciation Mgmt" },
        {
          icon: <CheckCircle size={iconSize} />,
          label: "Approvals",
    ...
    },
    {
      ...
      items: [
        { icon: <LayoutDashboard size={iconSize} />, label: "Dashboard" },
        { icon: <Contact2 size={iconSize} />, label: "Contact Management" },
        {
    ...
    },
    {
      ...
      items: [
        { icon: <LayoutDashboard size={iconSize} />, label: "Dashboard" },
        { icon: <Scale size={iconSize} />, label: "Contract Repository" },
        { icon: <FilePen size={iconSize} />, label: "Drafting & Templates" },
        { icon: <Inbox size={iconSize} />, label: "Requests Queue" },
      ],
    },
    {
      title: "KNOWLEDGE HUB",
      items: [
        { icon: <LayoutDashboard size={iconSize} />, label: "Dashboard" },
        { icon: <Library size={iconSize} />, label: "Proposal Library" },
