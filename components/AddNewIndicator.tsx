...
interface AddNewIndicatorProps {
  onBack: () => void;
}

/* ═══════════════════════════════════════════════════════════════════════════════
   FALLBACK DATA  (mirrors the project-creation module)
   ═══════════════════════════════════════════════════════════════════════════════ */

const PROJECT_NAME = "Youth Employment Skills Development";
...
export function AddNewIndicator({ onBack }: AddNewIndicatorProps) {
  const phases = DEFAULT_PHASES;
  const deliverables = DEFAULT_DELIVERABLES;
      ...
      <div className="bg-white border-b border-slate-200 shrink-0">
        <div className="px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-[16px] font-semibold text-slate-900">Add New Indicator</h1>
                    ...
                    {assignmentLevel === "Project" ? (
                      <div className="relative">
                        ...
                        >
                          ...
                          <option value="Youth Employment Skills Development">Youth Employment Skills Development</option>
                          ...
                          <option value="Clean Water Access Program">Clean Water Access Program</option>
                        </select>
                        <ChevronDown size={14} className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none" />
                      </div>
                    ) : (
            ...
            <div className="flex-1 overflow-auto px-6 py-5 space-y-5">
              ...
              <div>
                ...
                <div className="bg-slate-50 rounded-xl border border-slate-100 divide-y divide-slate-100">
                  ...
                  <ReviewRow label={getAssignmentLabel(assignmentLevel)} value={assignedTo} required />
