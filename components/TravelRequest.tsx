        ...
        <table className="w-full">
          <thead className="sticky top-0 z-[5]">
            <tr className="bg-blue-600 text-white">
              ...
              <th className="text-left px-6 py-3 text-[12px]">Destination</th>
              <th className="text-left px-6 py-3 text-[12px]">Purpose</th>
              <th className="text-left px-6 py-3 text-[12px]">Departure</th>
              <th className="text-left px-6 py-3 text-[12px]">Return</th>
              <th className="text-right px-6 py-3 text-[12px]">Est. Cost (GHS)</th>
