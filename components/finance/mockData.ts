...
export const mockSRDAccounts: SRDAccount[] = [
  {
    ...
    isControlAccount: false, taxApplicable: false, postingLevel: "Detail", accountGroup: "Current Assets — Cash & Equivalents",
  ...
  },
  {
    ...
    isControlAccount: true, controlType: "AR", taxApplicable: false, postingLevel: "Summary", accountGroup: "Current Assets — Receivables",
  ...
  },
  {
    ...
    isControlAccount: false, taxApplicable: false, postingLevel: "Detail", parentAccountId: "a4", accountGroup: "Current Assets — Receivables",
  ...
  },
  {
    ...
    isControlAccount: true, controlType: "FA", taxApplicable: false, postingLevel: "Summary", accountGroup: "Non-Current Assets — Fixed Assets",
  ...
  },
  {
    ...
    isControlAccount: true, controlType: "AP", taxApplicable: false, postingLevel: "Summary", accountGroup: "Current Liabilities",
  ...
  },
  {
    ...
    isControlAccount: false, taxApplicable: false, postingLevel: "Detail", accountGroup: "Current Liabilities",
  ...
  },
  {
    ...
    isControlAccount: false, taxApplicable: false, postingLevel: "Detail", accountGroup: "Equity — Reserves & Retained Earnings",
  ...
  },
  {
    ...
    isControlAccount: false, taxApplicable: false, postingLevel: "Detail", accountGroup: "Equity — Capital",
  ...
  },
  {
    ...
    isControlAccount: false, taxApplicable: false, postingLevel: "Detail", accountGroup: "Revenue — Operating",
  ...
  },
  {
    ...
    isControlAccount: false, taxApplicable: true, postingLevel: "Detail", accountGroup: "Operating Expenses — General & Admin",
  ...
  },
  {
    ...
    isControlAccount: false, taxApplicable: false, postingLevel: "Detail", accountGroup: "Depreciation & Amortization",
  ...
  },
  {
    ...
    isControlAccount: true, controlType: "Payroll", taxApplicable: false, postingLevel: "Summary", accountGroup: "Current Liabilities",
  ...
  },
  {
    ...
    isControlAccount: false, taxApplicable: false, postingLevel: "Detail", accountGroup: "Current Assets — Receivables",
  ...
  },
  {
    ...
    isControlAccount: false, taxApplicable: false, postingLevel: "Detail", accountGroup: "Revenue — Non-Operating",
  ...
  },
  {
    ...
    isControlAccount: false, taxApplicable: false, postingLevel: "Detail", parentAccountId: "a7", accountGroup: "Non-Current Assets — Acc. Depreciation",
  ...
  },
  {
    ...
    isControlAccount: false, taxApplicable: false, postingLevel: "Detail", accountGroup: "Current Assets — Prepaid & Other",
  ...
  {
    id: "a25", code: { entity: "01", businessUnit: "03", department: "01", account: "1300", costCenter: "001", intercompany: "00" },
    displayCode: "01-03-01-1300-001-00", name: "Staff Advances", type: "Asset", normalBalance: "Debit",
    isControlAccount: false, taxApplicable: false, postingLevel: "Detail", accountGroup: "Current Assets — Receivables",
    status: "Active", currency: "USD", balance: 0, department: "Finance", description: "Advances issued to staff pending settlement",
    effectiveDate: "2026-05-01", createdDate: "2026-05-01", lastTransaction: "", versionHistory: [
      { version: 1, changedBy: "Ama Darko", changedDate: "2026-05-01", changes: "Account created", effectiveDate: "2026-05-01" }
    ]
  },
  {
    id: "a26", code: { entity: "01", businessUnit: "03", department: "01", account: "1010", costCenter: "001", intercompany: "00" },
    displayCode: "01-03-01-1010-001-00", name: "Ecobank GHS Current Account", type: "Bank", normalBalance: "Debit",
    isControlAccount: false, taxApplicable: false, postingLevel: "Detail", accountGroup: "Current Assets — Bank Accounts",
    status: "Active", currency: "GHS", balance: 542800, department: "Finance", description: "Primary GHS operating account at Ecobank",
    effectiveDate: "2024-01-01", createdDate: "2024-01-01", lastTransaction: "2026-05-20", versionHistory: [
      { version: 1, changedBy: "System", changedDate: "2024-01-01", changes: "Account created", effectiveDate: "2024-01-01" }
    ]
  },
  {
    id: "a27", code: { entity: "01", businessUnit: "03", department: "01", account: "1011", costCenter: "001", intercompany: "00" },
    displayCode: "01-03-01-1011-001-00", name: "Stanbic USD Operating Account", type: "Bank", normalBalance: "Debit",
    isControlAccount: false, taxApplicable: false, postingLevel: "Detail", accountGroup: "Current Assets — Bank Accounts",
    status: "Active", currency: "USD", balance: 328500, department: "Finance", description: "USD operating account at Stanbic Bank",
    effectiveDate: "2024-01-01", createdDate: "2024-01-01", lastTransaction: "2026-05-18", versionHistory: [
      { version: 1, changedBy: "System", changedDate: "2024-01-01", changes: "Account created", effectiveDate: "2024-01-01" }
    ]
  },
  {
    id: "a28", code: { entity: "01", businessUnit: "03", department: "01", account: "1012", costCenter: "001", intercompany: "00" },
    displayCode: "01-03-01-1012-001-00", name: "GCB Donor Funds Account", type: "Bank", normalBalance: "Debit",
    isControlAccount: false, taxApplicable: false, postingLevel: "Detail", accountGroup: "Current Assets — Bank Accounts",
    status: "Active", currency: "GHS", balance: 1250000, department: "Finance", description: "Dedicated donor funds account at GCB",
    effectiveDate: "2024-06-01", createdDate: "2024-06-01", lastTransaction: "2026-05-15", versionHistory: [
      { version: 1, changedBy: "Finance Manager", changedDate: "2024-06-01", changes: "Account created", effectiveDate: "2024-06-01" }
    ]
  },
];
...
export const mockJournalEntries: SRDJournalEntry[] = [
  {
    id: "je1", entryNo: "2026-5001-01", entryType: "Standard", ledgerType: "Primary", status: "Posted",
  ...
  {
    id: "je2", entryNo: "2026-1101-02", entryType: "Standard", ledgerType: "Primary", status: "Posted",
  ...
  {
    id: "je3", entryNo: "2026-5010-03", entryType: "Adjusting", ledgerType: "Primary", status: "Posted",
  ...
  {
    id: "je4", entryNo: "2026-1102-04", entryType: "Revaluation", ledgerType: "Primary", status: "Posted",
  ...
  {
    id: "je5", entryNo: "2026-5002-05", entryType: "Standard", ledgerType: "Primary", status: "Approved",
  ...
  {
    id: "je6", entryNo: "2026-1500-06", entryType: "Standard", ledgerType: "Primary", status: "Submitted",
  ...
  {
    id: "je8", entryNo: "2026-1001-08", entryType: "Elimination", ledgerType: "Consolidation", status: "Posted",
