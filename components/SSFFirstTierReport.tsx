...
export function SSFFirstTierReport() {
  const [searchQuery, setSearchQuery] = useState("");
  const [selectedDepartment, setSelectedDepartment] = useState("All Departments");
  const [showDepartmentDropdown, setShowDepartmentDropdown] = useState(false);

  const ssfData = [
    { id: "1", employeeId: "EMP-001", employeeName: "John Smith", department: "Engineering", basicSalary: 8500, employeeContribution: 594, employerContribution: 765, totalContribution: 1359 },
    { id: "2", employeeId: "EMP-002", employeeName: "Sarah Johnson", department: "Sales", basicSalary: 7200, employeeContribution: 504, employerContribution: 648, totalContribution: 1152 },
    { id: "3", employeeId: "EMP-003", employeeName: "Michael Brown", department: "Marketing", basicSalary: 6800, employeeContribution: 476, employerContribution: 612, totalContribution: 1088 },
    { id: "4", employeeId: "EMP-004", employeeName: "Emily Davis", department: "Operations", basicSalary: 7500, employeeContribution: 525, employerContribution: 675, totalContribution: 1200 },
    { id: "5", employeeId: "EMP-005", employeeName: "David Wilson", department: "HR", basicSalary: 6500, employeeContribution: 455, employerContribution: 585, totalContribution: 1040 },
    { id: "6", employeeId: "EMP-006", employeeName: "Lisa Martinez", department: "Finance", basicSalary: 6200, employeeContribution: 434, employerContribution: 558, totalContribution: 992 },
    { id: "7", employeeId: "EMP-007", employeeName: "Tom Anderson", department: "Engineering", basicSalary: 7000, employeeContribution: 490, employerContribution: 630, totalContribution: 1120 },
    { id: "8", employeeId: "EMP-008", employeeName: "Rachel Green", department: "Sales", basicSalary: 5500, employeeContribution: 385, employerContribution: 495, totalContribution: 880 },
  ];
  ...
  return (
    <div className="h-full flex flex-col bg-slate-50 overflow-hidden">
      <div className="px-6 py-4 border-b border-slate-200 bg-white flex justify-between items-center">
        <h1 className="text-2xl font-semibold text-slate-900">SSF - First Tier Report</h1>
        ...
        <table className="w-full">
          <thead>
            <tr style={{ backgroundColor: "#0B01D0" }}>
              ...
              <th className="text-left px-4 py-3 text-white text-[12px] font-semibold border-b border-slate-100">Employee Contribution (7%)</th>
