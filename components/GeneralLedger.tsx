...
import { Search, Download, CheckCircle2, Clock, FileText, XCircle, Layers, BookOpen } from "lucide-react";
import type { SRDJournalEntry, JournalStatus } from "./finance/types";
import { mockJournalEntries, mockSRDAccounts } from "./finance/mockData";
import { JOURNAL_STATUSES } from "./finance/constants";
      ...
      <div className="px-6 py-4 border-b border-slate-200 bg-white">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-[12px] text-slate-500 mt-0.5">Consolidated ledger with full lifecycle management</p>
          </div>
          ...
          <table className="w-full">
            ...
            <tbody>
              ...
              {filteredEntries.length === 0 && (
                <tr>
                  <td colSpan={8} className="px-4 py-12 text-center text-[13px] text-slate-500">
            ...
            {entry.lines.map((line, i) => {
              ...
              return (
                <tr key={line.id} className="border-t border-slate-100">
                  ...
                  <td className="px-4 py-3">
                    <p className="text-[11px] font-mono text-slate-700">{acct?.code.account || line.accountId}</p>
