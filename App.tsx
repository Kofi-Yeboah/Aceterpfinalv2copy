...
import { HRDocumentVault } from "./components/HRDocumentVault";
import { PMODocumentVault } from "./components/PMODocumentVault";
import { CRMDocumentVault } from "./components/CRMDocumentVault";
...
import { DonorIntelligence } from "./pages/DonorIntelligence";
  ...
  const renderContent = () => {
    switch (selectedMenuItem) {
      case "EMPLOYEE SELF-SERVICE-Home":
        return <EmployeeHome onNavigate={(navKey: string) => setSelectedMenuItem(navKey)} />;
      ...
      case "EMPLOYEE SELF-SERVICE-My Requests-Loan Request":
        return <LoanRequest />;
      case "EMPLOYEE SELF-SERVICE-My Requests-Comms Request":
        return <CommsRequest />;
      case "EMPLOYEE SELF-SERVICE-Employee Timesheet":
        return <EmployeeTimesheet />;
      case "EMPLOYEE SELF-SERVICE-Employee Scorecard":
      ...
      case "PROJECT MANAGEMENT-Document Vault":
        return <PMODocumentVault />;
      ...
      case "CRM-Document Vault":
        return <CRMDocumentVault />;
      ...
      case "FINANCE-Asset Management-Assets":
        return <FinancialsAssetManagement />;
      case "FINANCE-Asset Management-Depreciation Mgmt":
