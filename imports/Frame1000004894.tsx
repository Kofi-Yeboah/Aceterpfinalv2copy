import svgPaths from "./svg-5zc9snjr50";
const imgRectangle4 = "https://picsum.photos/seed/1411/800/600";
const imgImage35 = "https://picsum.photos/seed/1441/800/600";

function BoldDuotoneUsersUsersGroupTwoRounded() {
  return (
    <div className="relative shrink-0 size-[18.967px]" data-name="Bold Duotone / Users / Users Group Two Rounded">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19 19">
        <g id="Bold Duotone / Users / Users Group Two Rounded">
          <g id="Vector">
            <path d={svgPaths.p39c82970} fill="var(--fill-0, #4137FF)" />
            <path d={svgPaths.p39c82970} stroke="var(--stroke-0, #4137FF)" />
          </g>
          <g id="Vector_2" opacity="0.4">
            <path d={svgPaths.pd884200} fill="var(--fill-0, #4137FF)" />
            <path d={svgPaths.pd884200} stroke="var(--stroke-0, #4137FF)" />
          </g>
          <path d={svgPaths.p229c0380} fill="var(--fill-0, #4137FF)" id="Vector_3" opacity="0.4" />
          <path d={svgPaths.p190e8a80} fill="var(--fill-0, #4137FF)" id="Vector_4" />
          <path d={svgPaths.p292d5480} fill="var(--fill-0, #4137FF)" id="Vector_5" opacity="0.4" />
          <path d={svgPaths.p22522500} fill="var(--fill-0, #4137FF)" id="Vector_6" opacity="0.4" />
        </g>
      </svg>
    </div>
  );
...
function Frame23() {
  return (
    <div className="bg-blue-50 box-border content-stretch flex gap-[7.903px] items-center justify-center p-[9.484px] relative rounded-[69.547px] shrink-0">
      <BoldDuotoneUsersUsersGroupTwoRounded />
    </div>
  );
}
...
function Frame93() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[16px] grow items-start min-h-px min-w-px relative shrink-0">
      <Frame115 />
      <p className="font-semibold leading-[28px] relative shrink-0 text-[22px] text-nowrap text-slate-900 tracking-[-0.44px] whitespace-pre">300</p>
    </div>
  );
}

function BoldDuotoneNatureTravelSuitcase() {
  return (
    <div className="relative shrink-0 size-[18.967px]" data-name="Bold Duotone / Nature, Travel / Suitcase">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19 19">
        <g id="Bold Duotone / Nature, Travel / Suitcase">
          <path d={svgPaths.p1d38ee40} fill="var(--fill-0, #6B21A8)" id="Vector" opacity="0.5" />
          <g id="Vector_2">
            <path d={svgPaths.p38350ac0} fill="var(--fill-0, #6B21A8)" />
            <path d={svgPaths.p3eeb5480} fill="var(--fill-0, #6B21A8)" />
            <path d={svgPaths.p38350ac0} stroke="var(--stroke-0, #6B21A8)" />
            <path d={svgPaths.p3eeb5480} stroke="var(--stroke-0, #6B21A8)" />
          </g>
          <path d={svgPaths.p1cfc3e00} fill="var(--fill-0, #6B21A8)" id="Vector_3" />
        </g>
      </svg>
    </div>
  );
...
function Frame24() {
  return (
    <div className="bg-purple-50 box-border content-stretch flex gap-[7.903px] items-center justify-center p-[9.484px] relative rounded-[69.547px] shrink-0">
      <BoldDuotoneNatureTravelSuitcase />
    </div>
  );
}
...
function Frame116() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0">
      <Frame24 />
      <p className="font-normal leading-[22px] relative shrink-0 text-[14px] text-nowrap text-slate-600 tracking-[-0.14px] whitespace-pre">Open Roles</p>
    </div>
  );
}
...
function Frame94() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[16px] grow items-start min-h-px min-w-px relative shrink-0">
      <Frame116 />
      <p className="font-semibold leading-[28px] relative shrink-0 text-[22px] text-nowrap text-slate-900 tracking-[-0.44px] whitespace-pre">120</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[18.967px]" data-name="Line Duotone / Time / History 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19 19">
        <g id="Line Duotone / Time / History 2">
          <path d={svgPaths.p17667ce0} id="Vector" stroke="var(--stroke-0, #5B21B6)" strokeLinecap="round" strokeWidth="1.18546" />
          <path d={svgPaths.p31a7cd00} id="Vector_2" opacity="0.5" stroke="var(--stroke-0, #5B21B6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.18546" />
          <circle cx="9.4837" cy="9.4837" id="Vector_3" opacity="0.5" r="7.90308" stroke="var(--stroke-0, #5B21B6)" strokeDasharray="0.4 2.77" strokeLinecap="round" strokeWidth="1.18546" />
        </g>
      </svg>
    </div>
  );
...
function Frame25() {
  return (
    <div className="bg-violet-50 box-border content-stretch flex gap-[7.903px] items-center justify-center p-[9.484px] relative rounded-[69.547px] shrink-0">
...
function Frame117() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0">
      <Frame25 />
      <p className="capitalize font-normal leading-[22px] relative shrink-0 text-[14px] text-nowrap text-slate-600 tracking-[-0.14px] whitespace-pre">pending Inteviews</p>
    </div>
  );
}
...
function Frame98() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[16px] grow items-start min-h-px min-w-px relative shrink-0">
      <Frame117 />
      <p className="font-semibold leading-[28px] relative shrink-0 text-[22px] text-nowrap text-slate-900 tracking-[-0.44px] whitespace-pre">40</p>
    </div>
  );
}
...
function Frame106() {
  return (
    <div className="content-stretch flex flex-col gap-[3.793px] items-start relative shrink-0">
      <p className="capitalize font-semibold leading-[17.071px] relative shrink-0 text-[#030047] text-[16px] text-nowrap whitespace-pre">Department Distribution</p>
    </div>
  );
}
      ...
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute bottom-0 left-0 right-0 top-[-0.95px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 498 1">
            <line id="Line 139" stroke="var(--stroke-0, #E2E8F0)" strokeWidth="0.94837" x2="497.065" y1="0.474185" y2="0.474185" />
          </svg>
        </div>
      </div>
    </div>
...
function Frame83() {
  return (
    <div className="content-stretch flex flex-col gap-[9.484px] items-start relative shrink-0 text-nowrap whitespace-pre">
      <p className="font-normal leading-[17.071px] relative shrink-0 text-[15.174px] text-slate-600">IT</p>
...
function Frame89() {
  return (
    <div className="content-stretch flex flex-col gap-[9.484px] items-start relative shrink-0 text-nowrap whitespace-pre">
      <p className="font-normal leading-[17.071px] relative shrink-0 text-[15.174px] text-slate-600">HR</p>
...
function Frame90() {
  return (
    <div className="content-stretch flex flex-col gap-[9.484px] items-start relative shrink-0 text-nowrap whitespace-pre">
      <p className="capitalize font-normal leading-[17.071px] relative shrink-0 text-[15.174px] text-slate-600">procurement</p>
      <p className="font-bold leading-[normal] relative shrink-0 text-[18.967px] text-slate-900">190</p>
    </div>
  );
}
...
function Frame92() {
  return (
    <div className="content-stretch flex flex-col gap-[9.484px] items-start relative shrink-0 text-nowrap whitespace-pre">
      <p className="font-normal leading-[17.071px] relative shrink-0 text-[15.174px] text-slate-600">Finance</p>
...
function Frame95() {
  return (
    <div className="content-stretch flex flex-col gap-[9.484px] items-start relative shrink-0 text-nowrap whitespace-pre">
      <p className="capitalize font-normal leading-[17.071px] relative shrink-0 text-[15.174px] text-slate-600">project Management</p>
  ...
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[42px] items-center pl-[10px] pr-0 py-0 relative size-full">
          <Frame112 />
          <Frame96 />
        </div>
      </div>
...
function Frame113() {
  return (
    <div className="basis-0 bg-white grow h-[361.329px] min-h-px min-w-px relative rounded-[12px] shrink-0">
...
function Frame108() {
  return (
    <div className="content-stretch flex flex-col gap-[3.793px] items-start relative shrink-0">
      <p className="capitalize font-semibold leading-[17.071px] relative shrink-0 text-[#030047] text-[16px] text-nowrap whitespace-pre">Employee Gender Distribution</p>
    </div>
  );
}
      ...
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute bottom-0 left-0 right-0 top-[-0.95px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 512 1">
            <line id="Line 139" stroke="var(--stroke-0, #E2E8F0)" strokeWidth="0.94837" x2="511.065" y1="0.474185" y2="0.474185" />
          </svg>
        </div>
      </div>
    </div>
    ...
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      ...
      <div className="[grid-area:1_/_1] h-[193.426px] ml-[13.65px] mt-[13.65px] relative w-[242.205px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 243 194">
          <path d={svgPaths.p159dba00} fill="var(--fill-0, #7E22CE)" id="Ellipse 527" />
        </svg>
      </div>
...
function Frame100() {
  return (
    <div className="content-stretch flex gap-[12.329px] items-start relative shrink-0">
      <div className="bg-purple-700 rounded-[5.319px] self-stretch shrink-0 w-[3.793px]" />
      <Frame99 />
    </div>
  );
}
...
function Frame114() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-[23.709px] h-[361px] items-center pb-[18.967px] pt-[15.174px] px-[18.967px] relative rounded-[12px] shrink-0 w-[549px]">
      <div aria-hidden="true" className="absolute border-[0.948px] border-slate-200 border-solid inset-0 pointer-events-none rounded-[12px]" />
      <Frame97 />
      <Frame109 />
    </div>
...
function Frame119() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] h-[543.264px] items-start left-[312px] top-[140px] w-[1104px]">
      <Frame121 />
      <Frame120 />
    </div>
  );
...
function BreadcrumbContainer() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[312px] min-w-[1104px] top-[78px] w-[1104px]" data-name="Breadcrumb Container">
      <p className="font-semibold leading-[28px] relative shrink-0 text-[22px] text-nowrap text-slate-900 tracking-[-0.44px] whitespace-pre">HR Management Dashboard</p>
      <Frame />
    </div>
  );
}
...
function LinearMoneySafe() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Money / Safe 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_247_15331)" id="Linear / Money / Safe 2">
...
function LinearMessagesConversationPlain() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Messages, Conversation / Plain 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_247_15059)" id="Linear / Messages, Conversation / Plain 2">
...
function LinearEssentionalUiHome() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Essentional, UI / Home">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_247_15254)" id="Linear / Essentional, UI / Home">
...
function LinearUsersUserCircle() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Users / User Circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_247_15241)" id="Linear / Users / User Circle">
...
function LinearUsersUserCircle1() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Users / User Circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_247_15381)" id="Linear / Users / User Circle">
          <circle cx="8" cy="6" id="Vector" r="2" stroke="var(--stroke-0, black)" />
          <circle cx="8" cy="8" id="Vector_2" r="6.66667" stroke="var(--stroke-0, black)" />
          <path d={svgPaths.p2f515480} id="Vector_3" stroke="var(--stroke-0, black)" strokeLinecap="round" />
        </g>
        <defs>
          <clipPath id="clip0_247_15381">
            <rect fill="white" height="16" width="16" />
          </clipPath>
        </defs>
      </svg>
...
function LinearBusinessStatisticChartSquare() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Business, Statistic / Chart Square">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_247_15248)" id="Linear / Business, Statistic / Chart Square">
          <path d={svgPaths.p13370480} id="Vector" stroke="var(--stroke-0, black)" />
...
function LinearBusinessStatisticChart() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Business, Statistic / Chart">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_247_15154)" id="Linear / Business, Statistic / Chart">
...
function LinearMoneyMoneyBag() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Money / Money Bag">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_247_15067)" id="Linear / Money / Money Bag">
    ...
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Notes / Documents Minimalistic">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Linear / Notes / Documents Minimalistic">
          <g clipPath="url(#clip0_247_15116)">
...
function LinearMapLocationGps() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Map & Location / GPS">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_247_15364)" id="Linear / Map & Location / GPS">
...
function LinearEssentionalUiBoxMinimalistic() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Essentional, UI / Box Minimalistic">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_247_15100)" id="Linear / Essentional, UI / Box Minimalistic">
...
function LinearFilesFileCheck() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Files / File Check">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_247_15054)" id="Linear / Files / File Check">
...
function LinearFilesFileText() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Files / File Text">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_247_15048)" id="Linear / Files / File Text">
          <path d={svgPaths.pc731100} fill="var(--stroke-0, black)" id="Vector" />
    ...
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Design, Tools / Ruler Pen">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Linear / Design, Tools / Ruler Pen">
          <g clipPath="url(#clip0_247_15043)">
...
function OutlineUsersUserCircle() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Outline / Users / User Circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_247_15040)" id="Outline / Users / User Circle">
          <g id="Vector">
...
function LinearBusinessStatisticChart5() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Business, Statistic / Chart">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_247_15034)" id="Linear / Business, Statistic / Chart">
          <path d="M14.6667 14.6667H1.33333" id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" />
          <path d={svgPaths.p3ac51b10} id="Vector_2" stroke="var(--stroke-0, black)" />
          <path d={svgPaths.p1a5aa680} id="Vector_3" stroke="var(--stroke-0, black)" />
          <path d={svgPaths.p239cea80} id="Vector_4" stroke="var(--stroke-0, black)" />
...
function LinearHandsHandHeart() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Hands / Hand Heart">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_247_15183)" id="Linear / Hands / Hand Heart">
