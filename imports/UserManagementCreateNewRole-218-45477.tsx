...
function Btn() {
  return (
    <div className="bg-white box-border content-stretch flex gap-[8px] h-[38px] items-center justify-center px-[16px] py-[11px] relative rounded-[8px] shrink-0" data-name="Btn">
      ...
      <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[14px] text-nowrap text-slate-700 whitespace-pre">Discard</p>
    </div>
  );
}
...
function Btn1() {
  return (
    <div className="bg-purple-700 box-border content-stretch flex gap-[8px] h-[38px] items-center justify-center px-[16px] py-[11px] relative rounded-[8px] shadow-[0px_1px_4px_0px_rgba(30,41,59,0.09)] shrink-0" data-name="Btn">
      ...
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[14px] text-nowrap text-white whitespace-pre">Save</p>
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-full">
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[12px] text-nowrap text-slate-700 tracking-[-0.24px] whitespace-pre">{`Name of role `}</p>
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-full">
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[12px] text-nowrap text-slate-700 tracking-[-0.24px] whitespace-pre">Role description</p>
    </div>
  );
}
...
function Frame20() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0">
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[15px] text-nowrap text-slate-400 whitespace-pre">Enter role description</p>
    </div>
  );
}
...
function Frame131() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[24px] relative shrink-0 text-[18px] text-nowrap text-slate-800 tracking-[-0.36px] whitespace-pre">Permissions</p>
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[22px] min-w-full relative shrink-0 text-[14px] text-slate-500 tracking-[-0.14px] w-[min-content]">This grants access to certain functions the user can perform. It can be used set limitations as well.</p>
    </div>
  );
}
...
function Frame37() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[5px] grow items-start min-h-px min-w-px relative shrink-0">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[14px] text-nowrap text-slate-900 whitespace-pre">Dashboard</p>
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[18px] min-w-full relative shrink-0 text-[12px] text-slate-600 w-[min-content]">User can view the main application dashboard.</p>
    </div>
  );
}
...
function Frame38() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[5px] grow items-start min-h-px min-w-px relative shrink-0">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[14px] text-nowrap text-slate-900 whitespace-pre">Order management</p>
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[18px] min-w-full relative shrink-0 text-[12px] text-slate-600 w-[min-content]">User can view the main application dashboard.</p>
    </div>
  );
}
...
function Frame39() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[5px] grow items-start min-h-px min-w-px relative shrink-0">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[14px] text-nowrap text-slate-900 whitespace-pre">Product management</p>
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[18px] min-w-full relative shrink-0 text-[12px] text-slate-600 w-[min-content]">User can view the main application dashboard.</p>
    </div>
  );
}
...
function Frame40() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[5px] grow items-start min-h-px min-w-px relative shrink-0">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[14px] text-nowrap text-slate-900 whitespace-pre">Inventory management</p>
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[18px] min-w-full relative shrink-0 text-[12px] text-slate-600 w-[min-content]">User can view the main application dashboard.</p>
    </div>
  );
}
...
function Frame41() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[5px] grow items-start min-h-px min-w-px relative shrink-0">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[14px] text-nowrap text-slate-900 whitespace-pre">Shipment management</p>
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[18px] min-w-full relative shrink-0 text-[12px] text-slate-600 w-[min-content]">User can view the main application dashboard.</p>
    </div>
  );
}
...
function Frame42() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[5px] grow items-start min-h-px min-w-px relative shrink-0">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[14px] text-nowrap text-slate-900 whitespace-pre">User management</p>
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[18px] min-w-full relative shrink-0 text-[12px] text-slate-600 w-[min-content]">User can view the main application dashboard.</p>
    </div>
  );
}
...
function Frame43() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[5px] grow items-start min-h-px min-w-px relative shrink-0">
      <p className="font-['Montserrat:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[14px] text-nowrap text-slate-900 tracking-[-0.56px] whitespace-pre">Customer management</p>
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[16px] min-w-full relative shrink-0 text-[#5f666b] text-[12px] w-[min-content]">User can view the main application dashboard.</p>
    </div>
  );
}
...
function Frame44() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[5px] grow items-start min-h-px min-w-px relative shrink-0">
      <p className="font-['Montserrat:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[14px] text-nowrap text-slate-900 tracking-[-0.56px] whitespace-pre">Finance management</p>
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[16px] min-w-full relative shrink-0 text-[#5f666b] text-[12px] w-[min-content]">User can view the main application dashboard.</p>
    </div>
  );
}
...
export default function UserManagementCreateNewRole() {
  return (
    <div className="bg-white relative size-full" data-name="user management - create new role">
      <Navbar />
      <p className="absolute font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[28px] left-[312px] text-[22px] text-nowrap text-slate-900 top-[83px] tracking-[-0.44px] whitespace-pre">Create a new role</p>
      <Frame130 />
      <Frame25 />
      <White />
    </div>
