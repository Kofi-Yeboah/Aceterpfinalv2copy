import svgPaths from "./svg-gg6tzemoyu";
...
function LineDuotoneTimeHistory() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Line Duotone / Time / History 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_229_76001)" id="Line Duotone / Time / History 2">
          <path d={svgPaths.p2fe0bb00} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeWidth="1.5" />
          <path d="M12 9V13H16" id="Vector_2" opacity="0.5" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <circle cx="12" cy="12" id="Vector_3" opacity="0.5" r="10" stroke="var(--stroke-0, white)" strokeDasharray="0.5 3.5" strokeLinecap="round" strokeWidth="1.5" />
        </g>
        <defs>
          <clipPath id="clip0_229_76001">
...
function Btn() {
  return (
    <div className="bg-purple-700 box-border content-stretch flex gap-[8px] h-[38px] items-center justify-center px-[16px] py-[11px] relative shadow-[0px_2px_2px_0px_rgba(0,0,0,0.04)] shrink-0" data-name="Btn">
      ...
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[14px] text-nowrap text-white whitespace-pre">Create Leave Request</p>
    </div>
  );
}
...
function BreadcrumbContainer() {
  return (
    <div className="content-stretch flex h-[38px] items-center justify-between min-w-[1104px] relative shrink-0 w-full" data-name="Breadcrumb Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] not-italic relative shrink-0 text-[22px] text-nowrap text-slate-900 tracking-[-0.44px] whitespace-pre">
        <span className="font-['Montserrat:SemiBold',sans-serif] text-slate-300">{`My Requests / `}</span>
...
function Frame2() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[14px] text-nowrap text-slate-900 whitespace-pre">All Time</p>
    </div>
  );
}
...
function Frame43() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[167px]">
      <TableCellHeading />
      <Frame56 />
      <Frame61 />
      <Frame57 />
...
function Frame48() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[187px]">
      <TableCellHeading4 />
      <Frame161 />
      <Frame162 />
      <Frame163 />
...
function Frame41() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-[89px]">
      <TableCellHeading6 />
...
function Frame81() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[10px] items-center justify-center p-[10px] relative shrink-0 size-[32px]">
      <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[14px] text-center text-nowrap text-slate-600 whitespace-pre">1</p>
    </div>
  );
}
...
function Frame83() {
  return (
    <div className="bg-slate-200 box-border content-stretch flex flex-col gap-[10px] items-center justify-center p-[10px] relative rounded-[4px] shrink-0 size-[24px]">
      <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[14px] text-center text-nowrap text-slate-900 whitespace-pre">2</p>
    </div>
  );
}
...
function Frame84() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[10px] items-center justify-center p-[10px] relative shrink-0 size-[32px]">
      <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[14px] text-center text-nowrap text-slate-600 whitespace-pre">...</p>
    </div>
  );
}
...
function Frame85() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[10px] items-center justify-center p-[10px] relative shrink-0 size-[32px]">
      <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[14px] text-center text-nowrap text-slate-600 whitespace-pre">7</p>
    </div>
  );
}
...
function Frame82() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[10px] items-center justify-center p-[10px] relative shrink-0 size-[32px]">
      <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[14px] text-center text-nowrap text-slate-600 whitespace-pre">8</p>
    </div>
  );
}
...
function Frame86() {
  return (
    <div className="content-stretch flex gap-[18px] items-center relative shrink-0">
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-none relative shrink-0 text-[12px] text-center text-nowrap text-slate-600 whitespace-pre">11-20 of 84 results</p>
      <Pagination />
    </div>
  );
}
...
function Frame154() {
  return (
    <div className="content-stretch flex flex-col h-[875px] items-start justify-between overflow-clip relative shrink-0 w-full">
      <Frame30 />
      <Frame29 />
    </div>
  );
...
function Frame185() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[36px] items-start left-[312px] top-[78px] w-[1104px]">
      <BreadcrumbContainer />
      <Frame157 />
      <Frame154 />
    </div>
...
function LinearMoneySafe() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Money / Safe 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_229_42123)" id="Linear / Money / Safe 2">
...
function LinearMessagesConversationPlain() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Messages, Conversation / Plain 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_229_42168)" id="Linear / Messages, Conversation / Plain 2">
...
function LinearEssentionalUiHome() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Essentional, UI / Home">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_229_42107)" id="Linear / Essentional, UI / Home">
...
function LinearUsersUserCircle() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Users / User Circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_229_32392)" id="Linear / Users / User Circle">
...
function BoldDuotoneUsersUserCheck() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Bold Duotone / Users / User Check">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Bold Duotone / Users / User Check">
          <path d={svgPaths.p1573a280} fill="var(--fill-0, #3B82F6)" id="Vector" />
          <path clipRule="evenodd" d={svgPaths.p3d24e8a0} fill="var(--fill-0, #3B82F6)" fillRule="evenodd" id="Vector_2" />
          <path d={svgPaths.p194c7700} fill="var(--fill-0, #3B82F6)" id="Subtract" opacity="0.5" />
        </g>
      </svg>
    </div>
  );
...
function Frame96() {
  return (
    <div className="basis-0 content-stretch flex gap-[10px] grow items-center min-h-px min-w-px relative shrink-0">
      <BoldDuotoneUsersUserCheck />
      <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[14px] text-blue-500 text-nowrap whitespace-pre">My Requests</p>
    </div>
  );
}
...
function SideNavItem11() {
  return (
    <div className="box-border content-stretch flex h-[38px] items-center justify-between px-[12px] py-[7px] relative rounded-[8px] shrink-0 w-[228px]" data-name="side nav item">
      <p className="basis-0 font-['Montserrat:Medium',sans-serif] font-medium grow leading-[normal] min-h-px min-w-px relative shrink-0 text-[14px] text-black tracking-[-0.14px]">Travel</p>
    </div>
  );
}
...
function Component17() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-end relative shrink-0 w-[256px]" data-name="Component 120">
      <SideNavItem9 />
      <SideNavItem10 />
      <SideNavItem11 />
    </div>
...
function Component18() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[256px]" data-name="Component 121">
      <Component17 />
    </div>
  );
}
...
function LinearBusinessStatisticChartSquare() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Business, Statistic / Chart Square">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_229_42073)" id="Linear / Business, Statistic / Chart Square">
          <path d={svgPaths.p13370480} id="Vector" stroke="var(--stroke-0, black)" />
...
function LinearBusinessStatisticChart() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Business, Statistic / Chart">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_229_33463)" id="Linear / Business, Statistic / Chart">
...
function LinearMoneyMoneyBag() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Money / Money Bag">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_229_41992)" id="Linear / Money / Money Bag">
    ...
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Notes / Documents Minimalistic">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Linear / Notes / Documents Minimalistic">
          <g clipPath="url(#clip0_229_42154)">
...
function LinearMapLocationGps() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Map & Location / GPS">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_229_33492)" id="Linear / Map & Location / GPS">
...
function LinearEssentionalUiBoxMinimalistic() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Essentional, UI / Box Minimalistic">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_229_33488)" id="Linear / Essentional, UI / Box Minimalistic">
...
function LinearFilesFileCheck() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Files / File Check">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_229_42201)" id="Linear / Files / File Check">
...
function LinearFilesFileText() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Files / File Text">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_229_41986)" id="Linear / Files / File Text">
          <path d={svgPaths.p27a89400} fill="var(--stroke-0, black)" id="Vector" />
    ...
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Design, Tools / Ruler Pen">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Linear / Design, Tools / Ruler Pen">
          <g clipPath="url(#clip0_229_41981)">
...
function OutlineUsersUserCircle() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Outline / Users / User Circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_229_42004)" id="Outline / Users / User Circle">
          <g id="Vector">
...
function LinearHandsHandHeart() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Hands / Hand Heart">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_229_42099)" id="Linear / Hands / Hand Heart">
