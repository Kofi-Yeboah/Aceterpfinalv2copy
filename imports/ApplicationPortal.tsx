import svgPaths from "./svg-mz2izsefbx";
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Outline / Essentional, UI / Add Circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_248_16677)" id="Outline / Essentional, UI / Add Circle">
          <g id="Vector">
...
function Frame96() {
  return (
    <div className="bg-white box-border content-stretch flex h-[38px] items-center justify-between px-[16px] py-[11px] relative rounded-[8px] shrink-0 w-[308px]">
...
function Frame95() {
  return (
    <div className="content-stretch flex gap-[14px] items-center min-w-[1104px] relative shrink-0 w-full">
      <Frame96 />
    </div>
  );
}
...
function Frame80() {
  return (
    <div className="bg-gradient-to-b from-[#cbd5e1] h-[148.334px] relative shrink-0 to-[#a4b1c1] w-full">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[8.062px] h-[148.334px] items-center px-[12.899px] py-[38.696px] relative w-full">
          <div className="absolute h-[150.941px] left-[calc(50%-0.01px)] top-[41.83px] translate-x-[-50%] w-[122.785px]" data-name="document with checkboxes and check mark">
...
function LinearSecurityEye() {
  return (
    <div className="relative shrink-0 size-[18px]" data-name="Linear / Security / Eye">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="Linear / Security / Eye">
          <path d={svgPaths.p15532c00} id="Vector" stroke="var(--stroke-0, white)" strokeWidth="1.08" />
          <path d={svgPaths.p35d8500} id="Vector_2" stroke="var(--stroke-0, white)" strokeWidth="1.08" />
        </g>
      </svg>
    </div>
  );
...
function Buttons() {
  return (
    <div className="bg-purple-700 box-border content-stretch flex gap-[4px] items-center justify-center overflow-clip px-[8px] py-[6px] relative rounded-[6px] shrink-0" data-name="Buttons [1.0]">
      <LinearSecurityEye />
      <Text />
    </div>
  );
    ...
    <div className="relative shrink-0 size-[24px]" data-name="Bold / Essentional, UI / Menu Dots">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Bold / Essentional, UI / Menu Dots">
          <g id="Vector">
            <path d={svgPaths.pa4a5600} fill="var(--fill-0, #475569)" />
            <path d={svgPaths.p3ca15c00} fill="var(--fill-0, #475569)" />
            <path d={svgPaths.p288b0b80} fill="var(--fill-0, #475569)" />
          </g>
        </g>
      </svg>
    </div>
...
function Frame111() {
  return (
    <div className="bg-slate-50 box-border content-stretch flex gap-[10px] items-center p-[4px] relative rounded-[6px] shrink-0">
      <div aria-hidden="true" className="absolute border border-slate-100 border-solid inset-0 pointer-events-none rounded-[6px]" />
...
function Frame86() {
  return (
    <div className="relative rounded-[12px] shrink-0 w-[244px]">
      <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] w-[244px]">
        <Frame80 />
        <Frame81 />
      </div>
      <div aria-hidden="true" className="absolute border border-slate-100 border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_2px_4px_0px_rgba(100,116,139,0.1)]" />
    </div>
  );
}
...
function LinearMoneySafe() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Money / Safe 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_248_16666)" id="Linear / Money / Safe 2">
...
function LinearMessagesConversationPlain() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Messages, Conversation / Plain 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_248_16637)" id="Linear / Messages, Conversation / Plain 2">
...
function LinearEssentionalUiHome() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Essentional, UI / Home">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_248_16610)" id="Linear / Essentional, UI / Home">
...
function LinearUsersUserCircle() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Users / User Circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_248_16602)" id="Linear / Users / User Circle">
...
function BoldDuotoneMessagesConversationPen() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Bold Duotone / Messages, Conversation / Pen 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Bold Duotone / Messages, Conversation / Pen 2">
          <path clipRule="evenodd" d={svgPaths.p8373900} fill="var(--fill-0, #3B82F6)" fillRule="evenodd" id="Vector" opacity="0.5" />
          <path d={svgPaths.p102380c0} fill="var(--fill-0, #3B82F6)" id="Vector_2" opacity="0.5" />
          <path d={svgPaths.p2641f00} fill="var(--fill-0, #3B82F6)" id="Vector_3" />
        </g>
      </svg>
    </div>
  );
...
function LinearUsersUserCircle1() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Users / User Circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_248_16513)" id="Linear / Users / User Circle">
          <circle cx="8" cy="6" id="Vector" r="2" stroke="var(--stroke-0, black)" />
          <circle cx="8" cy="8" id="Vector_2" r="6.66667" stroke="var(--stroke-0, black)" />
          <path d={svgPaths.p2f515480} id="Vector_3" stroke="var(--stroke-0, black)" strokeLinecap="round" />
        </g>
        <defs>
          <clipPath id="clip0_248_16513">
            <rect fill="white" height="16" width="16" />
          </clipPath>
        </defs>
      </svg>
...
function Component1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Component 60">
      <Property1Frame1 />
    </div>
  );
}
...
function LinearBusinessStatisticChartSquare() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Business, Statistic / Chart Square">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_248_16686)" id="Linear / Business, Statistic / Chart Square">
          <path d={svgPaths.p13370480} id="Vector" stroke="var(--stroke-0, black)" />
...
function LinearBusinessStatisticChart() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Business, Statistic / Chart">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_248_16786)" id="Linear / Business, Statistic / Chart">
...
function LinearMoneyMoneyBag() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Money / Money Bag">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_248_16574)" id="Linear / Money / Money Bag">
    ...
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Notes / Documents Minimalistic">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Linear / Notes / Documents Minimalistic">
          <g clipPath="url(#clip0_248_16629)">
...
function LinearMapLocationGps() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Map & Location / GPS">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_248_16444)" id="Linear / Map & Location / GPS">
...
function LinearEssentionalUiBoxMinimalistic() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Essentional, UI / Box Minimalistic">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_248_16440)" id="Linear / Essentional, UI / Box Minimalistic">
...
function LinearFilesFileCheck() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Files / File Check">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_248_16431)" id="Linear / Files / File Check">
...
function LinearFilesFileText() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Files / File Text">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_248_16425)" id="Linear / Files / File Text">
          <path d={svgPaths.pc731100} fill="var(--stroke-0, black)" id="Vector" />
    ...
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Design, Tools / Ruler Pen">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Linear / Design, Tools / Ruler Pen">
          <g clipPath="url(#clip0_248_16416)">
...
function OutlineUsersUserCircle() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Outline / Users / User Circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_248_16641)" id="Outline / Users / User Circle">
          <g id="Vector">
...
function LinearBusinessStatisticChart5() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Business, Statistic / Chart">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_248_16410)" id="Linear / Business, Statistic / Chart">
          <path d="M14.6667 14.6667H1.33333" id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" />
          <path d={svgPaths.p3ac51b10} id="Vector_2" stroke="var(--stroke-0, black)" />
          <path d={svgPaths.p1a5aa680} id="Vector_3" stroke="var(--stroke-0, black)" />
          <path d={svgPaths.p239cea80} id="Vector_4" stroke="var(--stroke-0, black)" />
...
function LinearHandsHandHeart() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Hands / Hand Heart">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_248_16390)" id="Linear / Hands / Hand Heart">
...
export default function ApplicationPortal() {
  return (
    <div className="bg-white relative shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] size-full" data-name="Application portal">
      <Navbar />
      <BreadcrumbContainer />
      <MainContainer />
      <White />
