import svgPaths from "./svg-snvj7206eh";
const imgDocumentWithCheckboxesAndCheckMark = "https://picsum.photos/seed/2126/800/600";
const imgRectangle4 = "https://picsum.photos/seed/1428/800/600";
const imgImage35 = "https://picsum.photos/seed/1458/800/600";

function Frame95() {
  return <div className="absolute h-[28px] left-[312px] top-[85px] w-0" />;
}

function Frame82() {
  return (
    <div className="bg-slate-200 h-[148.334px] relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[8.062px] h-[148.334px] items-center px-[12.899px] py-[38.696px] relative w-full">
          <div className="absolute h-[150.941px] left-1/2 rounded-[4px] top-[41.83px] translate-x-[-50%] w-[122.785px]" data-name="document with checkboxes and check mark">
            <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[4px]">
              <img alt="" className="absolute h-[101.81%] left-[-2.01%] max-w-none top-[-2.15%] w-[104.02%]" src={imgDocumentWithCheckboxesAndCheckMark} />
            </div>
          </div>
        </div>
      </div>
...
function Frame85() {
  return (
    <div className="content-stretch flex gap-[6.449px] items-center relative shrink-0 w-[76.585px]">
      <p className="font-normal leading-[14.511px] relative shrink-0 text-[10px] text-nowrap text-slate-700 whitespace-pre">2 days ago</p>
    </div>
  );
}
...
function BoldEssentionalUiMenuDots() {
  return (
    <div className="relative shrink-0 size-[19.348px]" data-name="Bold / Essentional, UI / Menu Dots">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Bold / Essentional, UI / Menu Dots">
          <g id="Vector">
            <path d={svgPaths.p38ebbe80} fill="var(--fill-0, #64748B)" />
            <path d={svgPaths.p104d28f0} fill="var(--fill-0, #64748B)" />
            <path d={svgPaths.p20e06a00} fill="var(--fill-0, #64748B)" />
          </g>
        </g>
      </svg>
    </div>
...
function Frame94() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[182.193px]">
      <Frame85 />
  ...
  return (
    <div className="bg-white relative shrink-0 w-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[8.062px] items-start px-[12.899px] py-[8.062px] relative w-full">
          <p className="font-medium leading-[normal] relative shrink-0 text-[13px] text-nowrap text-slate-900 tracking-[-0.13px] whitespace-pre">Warranty-info.B-112.pdf</p>
          <Frame94 />
        </div>
      </div>
    </div>
...
function Frame91() {
  return (
    <div className="box-border content-stretch flex flex-col items-start overflow-clip relative rounded-[9.674px] shadow-[0px_1.612px_3.225px_0px_rgba(100,116,139,0.1)] shrink-0 w-[207.99px]">
      <Frame82 />
      <Frame83 />
    </div>
  );
...
function Frame86() {
  return (
    <div className="content-stretch flex gap-[6.449px] items-center relative shrink-0 w-[76.585px]">
      <p className="font-normal leading-[14.511px] relative shrink-0 text-[10px] text-nowrap text-slate-700 whitespace-pre">4 weeks ago</p>
    </div>
  );
}

function BoldEssentionalUiMenuDots1() {
  return (
    <div className="relative shrink-0 size-[19.348px]" data-name="Bold / Essentional, UI / Menu Dots">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Bold / Essentional, UI / Menu Dots">
...
function Frame87() {
  return (
    <div className="bg-white relative shrink-0 w-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[8.062px] items-start px-[12.899px] py-[8.062px] relative w-full">
          <p className="font-medium leading-[normal] relative shrink-0 text-[13px] text-nowrap text-slate-900 tracking-[-0.13px] whitespace-pre">Prudential-POL-654321.pdf</p>
          <Frame96 />
        </div>
      </div>
    </div>
...
function Frame89() {
  return (
    <div className="content-stretch flex gap-[6.449px] items-center relative shrink-0 w-[76.585px]">
      <p className="font-normal leading-[14.511px] relative shrink-0 text-[10px] text-nowrap text-slate-700 whitespace-pre">5 weeks ago</p>
    </div>
  );
}

function BoldEssentionalUiMenuDots2() {
  return (
    <div className="relative shrink-0 size-[19.348px]" data-name="Bold / Essentional, UI / Menu Dots">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Bold / Essentional, UI / Menu Dots">
...
function Frame90() {
  return (
    <div className="bg-white relative shrink-0 w-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[8.062px] items-start px-[12.899px] py-[8.062px] relative w-full">
          <p className="font-medium leading-[normal] relative shrink-0 text-[13px] text-nowrap text-slate-900 tracking-[-0.13px] whitespace-pre">Warranty-info.W-142.pdf</p>
          <Frame97 />
        </div>
      </div>
    </div>
...
function Frame103() {
  return (
    <div className="absolute content-start flex flex-wrap gap-[16px] items-start left-[312px] top-[234px] w-[1104px]">
      <Frame91 />
      <Frame92 />
      <Frame93 />
    </div>
...
function Frame98() {
  return (
    <div className="absolute content-stretch flex gap-[684px] h-[38px] items-center left-[312px] top-[78px] w-[1104px]">
      <p className="font-semibold leading-[28px] relative shrink-0 text-[22px] text-nowrap text-slate-900 tracking-[-0.44px] whitespace-pre">Document Vault</p>
    </div>
  );
}
...
function TabItem() {
  return (
    <div className="bg-purple-700 box-border content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[5px] relative rounded-[8px] shrink-0 w-[150px]" data-name="Tab item">
      ...
      <div className="flex flex-col font-semibold justify-center leading-[0] relative shrink-0 text-[14px] text-nowrap text-white tracking-[-0.14px]">
        <p className="leading-[18px] whitespace-pre">Asset Mgt.</p>
      </div>
    </div>
  );
}
...
function TabItem1() {
  return (
    <div className="box-border content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[5px] relative shrink-0 w-[150px]" data-name="Tab item">
      <div aria-hidden="true" className="absolute border-0 border-[#d0d5dd] border-solid inset-0 pointer-events-none" />
      <p className="font-normal leading-[18px] relative shrink-0 text-[14px] text-nowrap text-slate-500 tracking-[-0.14px] whitespace-pre">Project Mgt.</p>
    </div>
  );
}
...
function TabItem2() {
  return (
    <div className="box-border content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[5px] relative shrink-0 w-[150px]" data-name="Tab item">
      <div aria-hidden="true" className="absolute border-0 border-[#d0d5dd] border-solid inset-0 pointer-events-none" />
      <p className="font-normal leading-[18px] relative shrink-0 text-[14px] text-nowrap text-slate-500 tracking-[-0.14px] whitespace-pre">Procurement</p>
    </div>
  );
}
...
function TabItem3() {
  return (
    <div className="box-border content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[5px] relative shrink-0 w-[150px]" data-name="Tab item">
      <div aria-hidden="true" className="absolute border-0 border-[#d0d5dd] border-solid inset-0 pointer-events-none" />
      <p className="font-normal leading-[18px] relative shrink-0 text-[14px] text-nowrap text-slate-500 tracking-[-0.14px] whitespace-pre">HR Mgt.</p>
    </div>
  );
}
...
function TabItem4() {
  return (
    <div className="box-border content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[5px] relative shrink-0 w-[150px]" data-name="Tab item">
      <div aria-hidden="true" className="absolute border-0 border-[#d0d5dd] border-solid inset-0 pointer-events-none" />
      <p className="font-normal leading-[18px] relative shrink-0 text-[14px] text-nowrap text-slate-500 tracking-[-0.14px] whitespace-pre">Other Documents</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="bg-slate-100 box-border content-stretch flex gap-[5px] items-start p-[4px] relative rounded-[10px] shrink-0">
      <TabItem />
      <TabItem1 />
      <TabItem2 />
      <TabItem3 />
...
function Group() {
  return (
    <div className="absolute inset-[16.67%_17.09%_18.75%_16.67%]">
      <div className="absolute inset-[-4.84%_-4.72%_-4.85%_-4.72%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 17">
          <g id="Group 427319184">
            <path d={svgPaths.p2c64cb00} id="Vector" stroke="var(--stroke-0, #7E22CE)" strokeWidth="1.5" />
            <path d="M4.72437 1.94231V0.75" id="Vector_2" stroke="var(--stroke-0, #7E22CE)" strokeLinecap="round" strokeWidth="1.5" />
            <path d="M12.6731 1.94231V0.75" id="Vector_3" stroke="var(--stroke-0, #7E22CE)" strokeLinecap="round" strokeWidth="1.5" />
            <path d="M1.14743 5.9165H16.25" id="Vector_4" stroke="var(--stroke-0, #7E22CE)" strokeLinecap="round" strokeWidth="1.5" />
          </g>
        </svg>
      </div>
    </div>
...
function LinearTimeCalendarMinimalistic() {
  return (
    <div className="overflow-clip relative rounded-[5px] shrink-0 size-[24px]" data-name="Linear / Time / Calendar Minimalistic">
      <Group />
    </div>
  );
}
...
function Frame() {
  return (
    <div className="bg-white h-[38px] relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[16px] h-[38px] items-center px-[12px] py-[7px] relative w-full">
          <Frame2 />
...
function Frame102() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[312px] top-[156px] w-[1104px]">
      <Frame1 />
      <DatePicker />
    </div>
  );
...
function BoldDuotoneMoneySafe() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Bold Duotone / Money / Safe 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_218_53365)" id="Bold Duotone / Money / Safe 2">
          <g id="Subtract">
            <path d={svgPaths.p216b7480} fill="var(--fill-0, #3B82F6)" />
            <path d={svgPaths.p3525f200} fill="var(--fill-0, #3B82F6)" />
            <path d={svgPaths.p34a66c00} fill="var(--fill-0, #3B82F6)" />
            <path clipRule="evenodd" d={svgPaths.p12df9200} fill="var(--fill-0, #3B82F6)" fillRule="evenodd" />
          </g>
          <path clipRule="evenodd" d={svgPaths.p182e0280} fill="var(--fill-0, #3B82F6)" fillRule="evenodd" id="Subtract_2" opacity="0.5" />
        </g>
        <defs>
          <clipPath id="clip0_218_53365">
...
function Frame19() {
  return (
    <div className="basis-0 content-stretch flex gap-[10px] grow items-center min-h-px min-w-px relative shrink-0">
      <BoldDuotoneMoneySafe />
      <p className="font-medium leading-[normal] relative shrink-0 text-[14px] text-blue-500 text-nowrap whitespace-pre">Document Vault</p>
    </div>
  );
}
...
function Navbar() {
  return (
    <div className="absolute bg-gradient-to-l box-border content-stretch flex from-[#03003f] h-[57px] items-center justify-between left-1/2 pl-[28px] pr-[16px] py-[12px] to-[#0900a5] top-0 translate-x-[-50%] w-[1440px]" data-name="Navbar">
...
export default function FormViewIncompleteFormDropdown() {
  return (
    <div className="bg-slate-50 relative size-full" data-name="Form view - incomplete form dropdown">
      <Navbar />
      <Frame95 />
      <Frame103 />
      <Frame98 />
