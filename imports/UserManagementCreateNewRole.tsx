import svgPaths from "./svg-gaufxe2mw2";
...
function TableHeader() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Table header">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[12px] text-nowrap text-white tracking-[-0.24px] whitespace-pre">{`Name of role `}</p>
    </div>
  );
}
...
function TableHeaderCell() {
  return (
    <div className="bg-blue-800 h-[44px] relative shrink-0 w-full" data-name="Table header cell">
...
function TableCell() {
  return (
    <div className="h-[98px] relative shrink-0 w-full" data-name="Table cell">
      <div aria-hidden="true" className="absolute border-[0px_0px_1px] border-slate-100 border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[98px] items-center px-[24px] py-[16px] relative w-full">
          <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[12px] text-nowrap text-slate-700 tracking-[-0.12px] whitespace-pre">Super admin</p>
        </div>
      </div>
    </div>
  );
...
function TableCell1() {
  return (
    <div className="h-[98px] relative shrink-0 w-full" data-name="Table cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[98px] items-center px-[24px] py-[16px] relative w-full">
          <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[12px] text-nowrap text-slate-700 tracking-[-0.12px] whitespace-pre">HR Manager</p>
        </div>
      </div>
    </div>
  );
...
function TableCell2() {
  return (
    <div className="h-[98px] relative shrink-0 w-full" data-name="Table cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[98px] items-center px-[24px] py-[16px] relative w-full">
          <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[12px] text-nowrap text-slate-700 tracking-[-0.12px] whitespace-pre">Accountant</p>
        </div>
      </div>
    </div>
  );
...
function Column() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative shrink-0 w-[233px]" data-name="Column">
      <TableHeaderCell />
      <TableCell />
      <TableCell1 />
      <TableCell2 />
...
function TableHeader1() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Table header">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[12px] text-nowrap text-white tracking-[-0.24px] whitespace-pre">Role description</p>
    </div>
  );
}
...
function TextAndSupportingText() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow h-full items-start min-h-px min-w-px relative shrink-0" data-name="Text and supporting text">
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[20px] min-w-full relative shrink-0 text-[12px] text-slate-800 w-[min-content]">{`This is the highest authority, responsible for the platform's complete management.`}</p>
    </div>
  );
}
...
function TableCell4() {
  return (
    <div className="h-[98px] relative shrink-0 w-full" data-name="Table cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[98px] items-center px-[24px] py-[16px] relative w-full">
          <p className="basis-0 font-['Montserrat:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[12px] text-slate-800">Oversees human resource management, settings, and operations for their company on the platform.</p>
        </div>
      </div>
    </div>
  );
...
function TableCell5() {
  return (
    <div className="h-[98px] relative shrink-0 w-full" data-name="Table cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[98px] items-center px-[24px] py-[16px] relative w-full">
          <p className="basis-0 font-['Montserrat:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[12px] text-slate-800">Oversees all finance and accounting management, settings, and operations for their company.</p>
        </div>
      </div>
    </div>
  );
...
function TableHeader2() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Table header">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[18px] relative shrink-0 text-[12px] text-nowrap text-white whitespace-pre">Actions</p>
    </div>
  );
}
...
function LinearMessagesConversationPen() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Linear / Messages, Conversation / Pen 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Linear / Messages, Conversation / Pen 2">
          <path d="M4 22H20" id="Vector" stroke="var(--stroke-0, #1E40AF)" strokeLinecap="round" strokeWidth="1.5" />
          <path d={svgPaths.p38118900} id="Vector_2" stroke="var(--stroke-0, #1E40AF)" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function LinearEssentionalUiTrashBinTrash() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Linear / Essentional, UI / Trash Bin Trash">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Linear / Essentional, UI / Trash Bin Trash">
          <path d="M20.5 6H3.49992" id="Vector" stroke="var(--stroke-0, #1E40AF)" strokeLinecap="round" strokeWidth="1.5" />
          <path d={svgPaths.p1ea2de00} id="Vector_2" stroke="var(--stroke-0, #1E40AF)" strokeLinecap="round" strokeWidth="1.5" />
          <path d="M9.5 11L10 16" id="Vector_3" stroke="var(--stroke-0, #1E40AF)" strokeLinecap="round" strokeWidth="1.5" />
          <path d="M14.5 11L14 16" id="Vector_4" stroke="var(--stroke-0, #1E40AF)" strokeLinecap="round" strokeWidth="1.5" />
          <path d={svgPaths.p128d2000} id="Vector_5" stroke="var(--stroke-0, #1E40AF)" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Frame14() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center justify-center px-[6px] py-[8px] relative shrink-0 w-[40px]">
      <LinearEssentionalUiTrashBinTrash />
    </div>
  );
}
...
function TableCells() {
  return (
    <div className="bg-white h-[98px] relative shrink-0 w-full" data-name="Table cells">
      <div aria-hidden="true" className="absolute border-[0px_0px_1px] border-slate-100 border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[8px] h-[98px] items-center justify-center p-[16px] relative w-full">
          <Frame12 />
          <Frame14 />
        </div>
      </div>
...
function LinearEssentionalUiTrashBinTrash1() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Linear / Essentional, UI / Trash Bin Trash">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Linear / Essentional, UI / Trash Bin Trash">
...
function Frame15() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center justify-center px-[6px] py-[8px] relative shrink-0 w-[40px]">
      <LinearEssentionalUiTrashBinTrash1 />
    </div>
  );
}
...
function TableCells1() {
  return (
    <div className="basis-0 bg-white grow min-h-px min-w-px relative shrink-0 w-full" data-name="Table cells">
      <div aria-hidden="true" className="absolute border-[0px_0px_1px] border-slate-100 border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[8px] items-center justify-center p-[16px] relative size-full">
          <Frame13 />
          <Frame15 />
        </div>
      </div>
...
function Column2() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative self-stretch shrink-0 w-[191px]" data-name="Column">
      <TableHeaderCell2 />
...
function Content() {
  return (
    <div className="absolute bg-white content-stretch flex items-start left-[312px] overflow-clip top-[159px] w-[1093px]" data-name="Content">
      <Column />
      <Column1 />
      <Column2 />
    </div>
...
function LinearArrowsArrowLeft() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Arrows / Arrow Left">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_218_37321)" id="Linear / Arrows / Arrow Left">
          <path d={svgPaths.p371b0d00} id="Vector" stroke="var(--stroke-0, #7E22CE)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
        </g>
        <defs>
          <clipPath id="clip0_218_37321">
...
function Btn() {
  return (
    <div className="bg-white box-border content-stretch flex gap-[8px] h-[38px] items-center justify-center px-[16px] py-[11px] relative rounded-[8px] shrink-0" data-name="Btn">
      ...
      <LinearArrowsArrowLeft />
      <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[14px] text-nowrap text-slate-700 whitespace-pre">Back</p>
    </div>
  );
}
...
function Btn1() {
  return (
    <div className="bg-purple-700 box-border content-stretch flex gap-[8px] h-[38px] items-center justify-center px-[16px] py-[11px] relative shadow-[0px_2px_2px_0px_rgba(0,0,0,0.04)] shrink-0" data-name="Btn">
      ...
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[14px] text-nowrap text-white whitespace-pre">Add new role</p>
    </div>
  );
}
...
function Frame103() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-center left-[1149px] top-[78px]">
      <Btn />
...
function Frame19() {
  return (
    <div className="basis-0 content-stretch flex gap-[10px] grow items-center min-h-px min-w-px relative shrink-0">
      ...
      <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[14px] text-blue-500 text-nowrap whitespace-pre">User management</p>
    </div>
  );
}
...
export default function UserManagementCreateNewRole() {
  return (
    <div className="bg-white relative size-full" data-name="user management - create new role">
      <Navbar />
      <p className="absolute font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[28px] left-[312px] text-[22px] text-nowrap text-slate-900 top-[83px] tracking-[-0.44px] whitespace-pre">View all roles</p>
      <Content />
      <Frame103 />
      <White />
    </div>
