...
function TableHeader() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Table header">
      <p className="font-semibold leading-[normal] relative shrink-0 text-[12px] text-nowrap text-white tracking-[-0.24px] whitespace-pre">{`Name of role `}</p>
    </div>
  );
}
    ...
    <div className="h-[98px] relative shrink-0 w-full" data-name="Table cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[98px] items-center px-[24px] py-[16px] relative w-full">
          <p className="font-normal leading-[22px] relative shrink-0 text-[12px] text-nowrap text-slate-700 tracking-[-0.12px] whitespace-pre">Super admin</p>
        </div>
      </div>
    </div>
  );
...
function TableCell1() {
  return (
    <div className="h-[98px] relative shrink-0 w-full" data-name="Table cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[98px] items-center px-[24px] py-[16px] relative w-full">
          <p className="font-normal leading-[22px] relative shrink-0 text-[12px] text-nowrap text-slate-700 tracking-[-0.12px] whitespace-pre">HR Manager</p>
        </div>
      </div>
    </div>
  );
...
function TableCell2() {
  return (
    <div className="h-[98px] relative shrink-0 w-full" data-name="Table cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[98px] items-center px-[24px] py-[16px] relative w-full">
          <p className="font-normal leading-[22px] relative shrink-0 text-[12px] text-nowrap text-slate-700 tracking-[-0.12px] whitespace-pre">Accountant</p>
        </div>
      </div>
    </div>
  );
...
function TableHeader1() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Table header">
      <p className="font-semibold leading-[normal] relative shrink-0 text-[12px] text-nowrap text-white tracking-[-0.24px] whitespace-pre">Role description</p>
    </div>
  );
}
...
function TextAndSupportingText() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow h-full items-start min-h-px min-w-px relative shrink-0" data-name="Text and supporting text">
      <p className="font-normal leading-[20px] min-w-full relative shrink-0 text-[12px] text-slate-800 w-[min-content]">{`This is the highest authority, responsible for the platform's complete management.`}</p>
    </div>
  );
}
...
function TableCell4() {
  return (
    <div className="h-[98px] relative shrink-0 w-full" data-name="Table cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[98px] items-center px-[24px] py-[16px] relative w-full">
          <p className="basis-0 font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[12px] text-slate-800">Oversees human resource management, settings, and operations for their company on the platform.</p>
        </div>
      </div>
    </div>
  );
...
function TableCell5() {
  return (
    <div className="h-[98px] relative shrink-0 w-full" data-name="Table cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[98px] items-center px-[24px] py-[16px] relative w-full">
          <p className="basis-0 font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[12px] text-slate-800">Oversees all finance and accounting management, settings, and operations for their company.</p>
        </div>
      </div>
    </div>
  );
...
function TableHeader2() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Table header">
      <p className="font-semibold leading-[18px] relative shrink-0 text-[12px] text-nowrap text-white whitespace-pre">Actions</p>
    </div>
  );
}
...
function Btn() {
  return (
    <div className="bg-white box-border content-stretch flex gap-[8px] h-[38px] items-center justify-center px-[16px] py-[11px] relative rounded-[8px] shrink-0" data-name="Btn">
      ...
      <p className="font-medium leading-[normal] relative shrink-0 text-[14px] text-nowrap text-slate-700 whitespace-pre">Back</p>
    </div>
  );
}
...
function Btn1() {
  return (
    <div className="bg-purple-700 box-border content-stretch flex gap-[8px] h-[38px] items-center justify-center px-[16px] py-[11px] relative shadow-[0px_2px_2px_0px_rgba(0,0,0,0.04)] shrink-0" data-name="Btn">
      ...
      <p className="font-semibold leading-[normal] relative shrink-0 text-[14px] text-nowrap text-white whitespace-pre">Add new role</p>
    </div>
  );
}
...
export default function UserManagementCreateNewRole() {
  return (
    <div className="bg-white relative size-full" data-name="user management - create new role">
      <Navbar />
      <p className="absolute font-semibold leading-[28px] left-[312px] text-[22px] text-nowrap text-slate-900 top-[83px] tracking-[-0.44px] whitespace-pre">View all roles</p>
      <Content />
      <Frame103 />
      <White />
    </div>
