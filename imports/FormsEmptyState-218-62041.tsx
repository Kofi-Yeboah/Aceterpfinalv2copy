import svgPaths from "./svg-gdqpbhw161";
const imgRectangle4 = "https://picsum.photos/seed/1411/800/600";
const imgImage35 = "https://picsum.photos/seed/1441/800/600";

function OutlineEssentionalUiAddCircle() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Outline / Essentional, UI / Add Circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_218_20055)" id="Outline / Essentional, UI / Add Circle">
          <g id="Vector">
            <path d={svgPaths.p36f37000} fill="var(--fill-0, white)" />
            <path clipRule="evenodd" d={svgPaths.p26090480} fill="var(--fill-0, white)" fillRule="evenodd" />
          </g>
        </g>
        <defs>
          <clipPath id="clip0_218_20055">
...
function Btn() {
  return (
    <div className="bg-purple-700 box-border content-stretch flex gap-[8px] h-[38px] items-center justify-center px-[16px] py-[11px] relative shadow-[0px_2px_2px_0px_rgba(0,0,0,0.04)] shrink-0" data-name="Btn">
      ...
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[14px] text-nowrap text-white whitespace-pre">Send Message</p>
    </div>
  );
}
...
function Frame114() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[1105px]">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[22px] text-nowrap text-slate-900 tracking-[-0.44px] whitespace-pre">Notification Center</p>
      <Frame93 />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[17px]" data-name="search">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17 17">
        <g id="search">
          <path d={svgPaths.pc6f9580} id="Icon" stroke="var(--stroke-0, #667085)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.4" />
        </g>
      </svg>
    </div>
  );
...
function Frame4() {
  return (
    <div className="basis-0 content-stretch flex grow items-center justify-between min-h-px min-w-px relative shrink-0">
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[14px] text-nowrap text-slate-400 whitespace-pre">search for message or subject</p>
      <Search />
    </div>
  );
}
...
function InputFieldTypes() {
  return (
    <div className="bg-white box-border content-stretch flex h-full items-center justify-between px-[12px] py-[6px] relative rounded-[10px] shrink-0 w-[381px]" data-name="Input field types">
...
function Frame2() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[14px] text-nowrap text-slate-900 whitespace-pre">All Channels</p>
    </div>
  );
}
...
function Frame95() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[1104px]">
...
function TableHeader() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Table header">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[12px] text-nowrap text-white whitespace-pre">Date</p>
    </div>
  );
}
...
function TableHeaderCell() {
  return (
    <div className="bg-blue-800 relative shrink-0 w-full" data-name="Table header cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[12px] items-center px-[32px] py-[10px] relative w-full">
          <TableHeader />
        </div>
      </div>
    </div>
...
function TableCell() {
  return (
    <div className="h-[72px] relative shrink-0 w-full" data-name="Table cell">
      <div aria-hidden="true" className="absolute border-[0px_0px_1px] border-slate-100 border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[72px] items-center px-[32px] py-[16px] relative w-full">
          <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#667085] text-[12px] text-nowrap whitespace-pre">21st June, 2025</p>
        </div>
      </div>
    </div>
  );
...
function TableCell1() {
  return (
    <div className="h-[72px] relative shrink-0 w-full" data-name="Table cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[72px] items-center px-[32px] py-[16px] relative w-full">
          <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#667085] text-[12px] text-nowrap whitespace-pre">1st July, 2025</p>
        </div>
      </div>
    </div>
  );
...
function TableCell2() {
  return (
    <div className="h-[72px] relative shrink-0 w-full" data-name="Table cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[72px] items-center px-[32px] py-[16px] relative w-full">
          <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#667085] text-[12px] text-nowrap whitespace-pre">14th July, 2025</p>
        </div>
      </div>
    </div>
  );
...
function Column() {
  return (
    <div className="basis-0 bg-white content-stretch flex flex-col grow items-start min-h-px min-w-px relative shrink-0" data-name="Column">
      <TableHeaderCell />
      <TableCell />
      <TableCell1 />
      <TableCell2 />
...
function TableHeader1() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Table header">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[12px] text-nowrap text-white whitespace-pre">Subject</p>
    </div>
  );
}
...
function TableHeaderCell1() {
  return (
    <div className="bg-blue-800 relative shrink-0 w-full" data-name="Table header cell">
      <div aria-hidden="true" className="absolute border-[0px_0px_1px] border-slate-100 border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[12px] items-center px-[24px] py-[10px] relative w-full">
          <TableHeader1 />
        </div>
      </div>
    </div>
    ...
    <div className="h-[72px] relative shrink-0 w-full" data-name="Table cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[72px] items-center px-[24px] py-[16px] relative w-full">
          <p className="[white-space-collapse:collapse] basis-0 font-['Montserrat:Medium',sans-serif] font-medium grow leading-[20px] min-h-px min-w-px overflow-ellipsis overflow-hidden relative shrink-0 text-[12px] text-nowrap text-slate-600">System-wide maintenance due from 12:00am to 5:00am.</p>
        </div>
      </div>
    </div>
  );
...
function TableCell4() {
  return (
    <div className="h-[72px] relative shrink-0 w-full" data-name="Table cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[72px] items-center px-[24px] py-[16px] relative w-full">
          <p className="[white-space-collapse:collapse] basis-0 font-['Montserrat:Medium',sans-serif] font-medium grow leading-[20px] min-h-px min-w-px overflow-ellipsis overflow-hidden relative shrink-0 text-[12px] text-nowrap text-slate-600">Happy new Month, People!!! Enjoy this month with Grace and Favor.</p>
        </div>
      </div>
    </div>
  );
...
function TableCell5() {
  return (
    <div className="h-[72px] relative shrink-0 w-full" data-name="Table cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[72px] items-center px-[24px] py-[16px] relative w-full">
          <p className="[white-space-collapse:collapse] basis-0 font-['Montserrat:Medium',sans-serif] font-medium grow leading-[20px] min-h-px min-w-px overflow-ellipsis overflow-hidden relative shrink-0 text-[12px] text-nowrap text-slate-600">Cybersecurity training for all: New phishing scams to watch out for.</p>
        </div>
      </div>
    </div>
  );
...
function Column1() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative shrink-0 w-[487px]" data-name="Column">
      <TableHeaderCell1 />
      <TableCell3 />
      <TableCell4 />
      <TableCell5 />
...
function TableHeader2() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Table header">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[12px] text-nowrap text-white whitespace-pre">Type</p>
    </div>
  );
}
...
function TableCell6() {
  return (
    <div className="h-[72px] relative shrink-0 w-full" data-name="Table cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[72px] items-center px-[24px] py-[16px] relative w-full">
          <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[12px] text-nowrap text-slate-600 whitespace-pre">In-App</p>
        </div>
      </div>
    </div>
  );
...
function TableCell7() {
  return (
    <div className="h-[72px] relative shrink-0 w-full" data-name="Table cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[72px] items-center px-[24px] py-[16px] relative w-full">
          <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[12px] text-nowrap text-slate-600 whitespace-pre">SMS</p>
        </div>
      </div>
    </div>
  );
...
function TableCell8() {
  return (
    <div className="h-[72px] relative shrink-0 w-full" data-name="Table cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[72px] items-center px-[24px] py-[16px] relative w-full">
          <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[12px] text-nowrap text-slate-600 whitespace-pre">Email</p>
        </div>
      </div>
    </div>
  );
...
function TableHeader3() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Table header">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[12px] text-nowrap text-white whitespace-pre">Recipients</p>
    </div>
  );
}
...
function TableCell9() {
  return (
    <div className="h-[72px] relative shrink-0 w-full" data-name="Table cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[72px] items-center px-[24px] py-[16px] relative w-full">
          <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#667085] text-[12px] text-nowrap whitespace-pre">4455</p>
        </div>
      </div>
    </div>
  );
...
function TableCell10() {
  return (
    <div className="h-[72px] relative shrink-0 w-full" data-name="Table cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[72px] items-center px-[24px] py-[16px] relative w-full">
          <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#667085] text-[12px] text-nowrap whitespace-pre">53</p>
        </div>
      </div>
    </div>
  );
...
function TableHeader4() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Table header">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[12px] text-nowrap text-white whitespace-pre">Actions</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-blue-800 relative shrink-0 w-full" data-name="Table header cell">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[12px] items-center justify-center px-[24px] py-[10px] relative w-full">
          <TableHeader4 />
        </div>
      </div>
    </div>
...
function BoldEssentionalUiMenuDots() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Bold / Essentional, UI / Menu Dots">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Bold / Essentional, UI / Menu Dots">
          <g id="Vector">
            <path d={svgPaths.p2504fb00} fill="var(--fill-0, #1E40AF)" />
            <path d={svgPaths.p1bda5480} fill="var(--fill-0, #1E40AF)" />
            <path d={svgPaths.p32dbf180} fill="var(--fill-0, #1E40AF)" />
          </g>
        </g>
      </svg>
    </div>
...
function TableCell11() {
  return (
    <div className="h-[72px] relative shrink-0 w-full" data-name="Table cell">
      <div aria-hidden="true" className="absolute border-[0px_0px_1px] border-slate-100 border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[8px] h-[72px] items-center justify-center px-[24px] py-[16px] relative w-full">
...
function Content() {
  return (
    <div className="bg-white content-stretch flex items-start overflow-clip relative shrink-0 w-full" data-name="Content">
      <Column />
      <Column1 />
      <Column2 />
      <Column3 />
...
function Frame115() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[36px] items-start left-[312px] max-w-[1104px] top-[78px] w-[1104px]">
      <Frame114 />
      <Frame95 />
      <Content />
    </div>
...
function LinearArrowsAltArrowDown2() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Arrows / Alt Arrow Down">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Linear / Arrows / Alt Arrow Down">
          <path d="M12.6667 6L8 10L3.33333 6" id="Vector" stroke="var(--stroke-0, #EB0069)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="relative shrink-0 size-[16px]" data-name="Line Duotone / Arrows / Alt Arrow Left">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Line Duotone / Arrows / Alt Arrow Left">
          <path d="M10 3.33333L6 8L10 12.6667" id="Vector" stroke="var(--stroke-0, #EB0069)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Frame21() {
  return (
    <div className="bg-[#fff1f7] box-border content-stretch flex flex-col gap-[10px] items-center justify-center p-[10px] relative rounded-[4px] shrink-0 size-[24px]">
      <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#eb0069] text-[14px] text-center text-nowrap whitespace-pre">2</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[16px]" data-name="Line Duotone / Arrows / Alt Arrow Right">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Line Duotone / Arrows / Alt Arrow Right">
          <path d="M6 3.33333L10 8L6 12.6667" id="Vector" stroke="var(--stroke-0, #EB0069)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Frame18() {
  return (
    <div className="absolute bg-white bottom-0 box-border content-stretch flex gap-[10px] items-center justify-end left-[320px] px-[16px] py-[8px] w-[1088px]">
      <FullPagination />
    </div>
  );
}
...
function BoldDuotoneMessagesConversationPlain() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Bold Duotone / Messages, Conversation / Plain 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Bold Duotone / Messages, Conversation / Plain 2">
          <path clipRule="evenodd" d={svgPaths.p3e440720} fill="var(--fill-0, #3B82F6)" fillRule="evenodd" id="Vector" />
          <path d={svgPaths.p1b5a9700} fill="var(--fill-0, #3B82F6)" id="Vector_2" opacity="0.5" />
        </g>
      </svg>
    </div>
  );
...
function Frame30() {
  return (
    <div className="basis-0 content-stretch flex gap-[10px] grow items-center min-h-px min-w-px relative shrink-0">
      <BoldDuotoneMessagesConversationPlain />
      <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[14px] text-blue-500 text-nowrap whitespace-pre">Notification Center</p>
    </div>
  );
}
...
export default function FormsEmptyState() {
  return (
    <div className="bg-white relative size-full" data-name="Forms - empty state">
      <Navbar />
      <Frame115 />
      <Frame18 />
      <White />
