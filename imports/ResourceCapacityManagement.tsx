...
function Frame167() {
  return (
    <div className="absolute content-stretch flex h-[38px] items-center justify-between left-[312px] min-w-[1104px] top-[78px] w-[1104px]">
      <p className="font-semibold leading-[28px] relative shrink-0 text-[22px] text-nowrap text-slate-900 tracking-[-0.44px] whitespace-pre">{`Resource & Capacity Management`}</p>
    </div>
  );
}
    ...
    <div className="bg-blue-800 relative shrink-0 w-full" data-name="Table cell heading">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center p-[16px] relative w-full">
          <p className="font-semibold leading-[normal] relative shrink-0 text-[12px] text-nowrap text-white whitespace-pre">Staff/Expert</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="bg-blue-800 h-[47px] relative shrink-0 w-full" data-name="Table cell heading">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[47px] items-center p-[16px] relative w-full">
          <p className="font-semibold leading-[normal] relative shrink-0 text-[12px] text-nowrap text-white whitespace-pre">Role</p>
        </div>
      </div>
    </div>
  );
...
function Frame27() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center relative shrink-0">
      <p className="font-medium leading-[normal] relative shrink-0 text-[#667085] text-[12px] text-nowrap whitespace-pre">Project Manager</p>
    </div>
  );
}
...
function Frame28() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center relative shrink-0">
      <p className="font-medium leading-[normal] relative shrink-0 text-[#667085] text-[12px] text-nowrap whitespace-pre">Senior Researcher</p>
    </div>
  );
}
...
function Frame29() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center relative shrink-0">
      <p className="font-medium leading-[normal] relative shrink-0 text-[#667085] text-[12px] text-nowrap whitespace-pre">Research Assistant</p>
    </div>
  );
}
...
function TableCellHeading2() {
  return (
    <div className="bg-blue-800 h-[47px] relative shrink-0 w-full" data-name="Table cell heading">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[47px] items-center p-[16px] relative w-full">
          <p className="font-semibold leading-[normal] relative shrink-0 text-[12px] text-nowrap text-white whitespace-pre">Skills</p>
        </div>
      </div>
    </div>
  );
...
function Frame30() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center relative shrink-0">
      <ul className="[white-space-collapse:collapse] block font-medium leading-[0] relative shrink-0 text-[#667085] text-[12px] text-nowrap">
    ...
    <div className="bg-blue-800 relative shrink-0 w-full" data-name="Table cell heading">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center pl-[12px] pr-[16px] py-[16px] relative w-full">
          <p className="font-semibold leading-[normal] relative shrink-0 text-[12px] text-nowrap text-white whitespace-pre">Availability (%)</p>
        </div>
      </div>
    </div>
  );
...
function Frame36() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] items-start justify-center relative shrink-0">
      <p className="font-normal leading-none relative shrink-0 text-[12px] text-nowrap text-slate-600 whitespace-pre">10%</p>
    </div>
  );
}
...
function Frame37() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] items-start justify-center relative shrink-0">
      <p className="font-normal leading-none relative shrink-0 text-[12px] text-nowrap text-slate-600 whitespace-pre">25%</p>
    </div>
  );
}
...
function Frame38() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] items-start justify-center relative shrink-0">
      <p className="font-normal leading-none relative shrink-0 text-[12px] text-nowrap text-slate-600 whitespace-pre">0%</p>
    </div>
  );
}
...
function Frame39() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] items-start justify-center relative shrink-0">
      <p className="font-normal leading-none relative shrink-0 text-[12px] text-nowrap text-slate-600 whitespace-pre">40%</p>
    </div>
  );
}
...
function TableCellHeading4() {
  return (
    <div className="bg-blue-800 h-[47px] relative shrink-0 w-full" data-name="Table cell heading">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[47px] items-center p-[16px] relative w-full">
          <p className="font-semibold leading-[normal] relative shrink-0 text-[12px] text-nowrap text-white whitespace-pre">Assigned Projects</p>
        </div>
      </div>
    </div>
  );
...
function Frame128() {
  return (
    <div className="basis-0 content-stretch flex gap-[10px] grow items-center min-h-px min-w-px relative shrink-0">
      ...
      <p className="font-medium leading-[normal] relative shrink-0 text-[14px] text-blue-500 text-nowrap whitespace-pre">{`Resource & Capacity Mgnt.`}</p>
    </div>
  );
}
