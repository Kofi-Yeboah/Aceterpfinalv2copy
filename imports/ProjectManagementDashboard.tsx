import svgPaths from "./svg-dlycb1ms00";
...
function Frame132() {
  return (
    <div className="absolute content-stretch flex h-[38px] items-center justify-between left-[312px] min-w-[1104px] top-[78px] w-[1104px]">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[22px] text-nowrap text-slate-900 tracking-[-0.44px] whitespace-pre">Project Management Dashboard</p>
    </div>
  );
}
...
function Frame115() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0">
      <Frame22 />
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[14px] text-nowrap text-slate-600 tracking-[-0.14px] whitespace-pre">Total Active Projects</p>
    </div>
  );
}
...
function Frame92() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[16px] grow items-start min-h-px min-w-px relative shrink-0">
      <Frame115 />
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[22px] text-nowrap text-slate-900 whitespace-pre">124</p>
    </div>
  );
}
...
function Frame116() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0">
      <Frame23 />
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[14px] text-nowrap text-slate-600 tracking-[-0.14px] whitespace-pre">Overdue Tasks:</p>
    </div>
  );
}
...
function Frame93() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[16px] grow items-start min-h-px min-w-px relative shrink-0">
      <Frame116 />
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[22px] text-nowrap text-slate-900 whitespace-pre">11</p>
    </div>
  );
}

function BoldDuotoneUsersUsersGroupRounded() {
  return (
    <div className="relative shrink-0 size-[18.967px]" data-name="Bold Duotone / Users / Users Group Rounded">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19 19">
        <g id="Bold Duotone / Users / Users Group Rounded">
          <g id="Vector" opacity="0.4">
            <circle cx="11.8546" cy="4.74185" fill="var(--fill-0, #2DD4BF)" r="2.37092" />
            <circle cx="11.8546" cy="4.74185" r="2.37092" stroke="var(--stroke-0, #2DD4BF)" />
          </g>
          <g id="Vector_2" opacity="0.4">
            <path d={svgPaths.p2251a580} fill="var(--fill-0, #2DD4BF)" />
            <path d={svgPaths.p2251a580} stroke="var(--stroke-0, #2DD4BF)" />
          </g>
          <g id="Vector_3">
            <circle cx="7.11354" cy="4.74185" fill="var(--fill-0, #2DD4BF)" r="3.16123" />
            <circle cx="7.11354" cy="4.74185" r="3.16123" stroke="var(--stroke-0, #2DD4BF)" />
          </g>
          <ellipse cx="7.11354" cy="13.436" fill="var(--fill-0, #2DD4BF)" id="Vector_4" rx="5.53216" ry="3.16123" />
        </g>
      </svg>
    </div>
  );
...
function Frame24() {
  return (
    <div className="bg-white box-border content-stretch flex gap-[7.903px] items-center justify-center p-[9.484px] relative rounded-[69.547px] shrink-0">
      <BoldDuotoneUsersUsersGroupRounded />
    </div>
  );
}
...
function Frame117() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0">
      <Frame24 />
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[14px] text-nowrap text-slate-600 tracking-[-0.14px] whitespace-pre">Team Capacity</p>
    </div>
  );
}
...
function Frame97() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[16px] grow items-start min-h-px min-w-px relative shrink-0">
      <Frame117 />
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[22px] text-nowrap text-slate-900 whitespace-pre">64%</p>
    </div>
  );
}
...
function Frame105() {
  return (
    <div className="content-stretch flex flex-col gap-[3.793px] items-start relative shrink-0">
      <p className="capitalize font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[17.071px] relative shrink-0 text-[#030047] text-[16px] text-nowrap whitespace-pre">Projects by Risk Level</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[268.874px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 269 269">
        <g id="Frame 1000004280">
          ...
          <path d={svgPaths.p3482d200} fill="var(--fill-0, #22C55E)" id="Ellipse 530" />
          <path d={svgPaths.p176c4f00} fill="var(--fill-0, #DC2626)" id="Ellipse 529" />
        </g>
      </svg>
    </div>
  );
...
function Frame82() {
  return (
    <div className="content-stretch flex flex-col gap-[9.484px] items-start relative shrink-0 text-nowrap whitespace-pre">
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[17.071px] relative shrink-0 text-[15.174px] text-slate-600">Low</p>
...
function Frame84() {
  return (
    <div className="content-stretch flex gap-[12.329px] items-start relative shrink-0">
      <div className="bg-green-500 rounded-[5.319px] self-stretch shrink-0 w-[3.793px]" />
      <Frame82 />
    </div>
  );
}
...
function Frame88() {
  return (
    <div className="content-stretch flex flex-col gap-[9.484px] items-start relative shrink-0 text-nowrap whitespace-pre">
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[17.071px] relative shrink-0 text-[15.174px] text-slate-600">Medium</p>
      <p className="font-['Montserrat:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[18.967px] text-slate-900">61</p>
    </div>
  );
}
...
function Frame85() {
  return (
    <div className="content-stretch flex gap-[12.329px] items-start relative shrink-0">
      <div className="bg-amber-500 rounded-[5.319px] self-stretch shrink-0 w-[3.793px]" />
      <Frame88 />
    </div>
  );
}
...
function Frame89() {
  return (
    <div className="content-stretch flex flex-col gap-[9.484px] items-start relative shrink-0 text-nowrap whitespace-pre">
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[17.071px] relative shrink-0 text-[15.174px] text-slate-600">High</p>
...
function Frame83() {
  return (
    <div className="content-stretch flex gap-[12.329px] items-start relative shrink-0">
      <div className="bg-red-600 rounded-[5.319px] self-stretch shrink-0 w-[3.793px]" />
      <Frame89 />
    </div>
  );
}
...
function Frame107() {
  return (
    <div className="content-stretch flex flex-col gap-[3.793px] items-start relative shrink-0">
      <p className="capitalize font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[17.071px] relative shrink-0 text-[#030047] text-[16px] text-nowrap whitespace-pre">Project Status Distribution</p>
    </div>
  );
}
...
function Frame112() {
  return (
    <div className="relative size-[268.874px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 269 269">
        <g id="Frame 1000004280">
          <rect fill="var(--fill-0, #F1F5F9)" height="268.874" rx="134.437" width="268.874" />
          <path d={svgPaths.p22f37100} fill="var(--fill-0, #FFC803)" id="Ellipse 527" />
          <path d={svgPaths.p248f23d0} fill="var(--fill-0, #6B21A8)" id="Ellipse 528" />
...
function Frame91() {
  return (
    <div className="content-stretch flex flex-col gap-[9.484px] items-start relative shrink-0 text-nowrap whitespace-pre">
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[17.071px] relative shrink-0 text-[15.174px] text-slate-600">Ongoing</p>
...
function Frame95() {
  return (
    <div className="content-stretch flex flex-col gap-[9.484px] items-start relative shrink-0 text-nowrap whitespace-pre">
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[17.071px] relative shrink-0 text-[15.174px] text-slate-600">Planned</p>
...
function Frame98() {
  return (
    <div className="content-stretch flex flex-col gap-[9.484px] items-start relative shrink-0 text-nowrap whitespace-pre">
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[17.071px] relative shrink-0 text-[15.174px] text-slate-600">Completed</p>
      <p className="font-['Montserrat:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[18.967px] text-slate-900">190</p>
    </div>
  );
}
...
function Frame100() {
  return (
    <div className="content-stretch flex flex-col gap-[9.484px] items-start relative shrink-0 text-nowrap whitespace-pre">
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[17.071px] relative shrink-0 text-[15.174px] text-slate-600">On Hold</p>
...
function Frame102() {
  return (
    <div className="content-stretch flex flex-col h-[226px] items-start justify-between relative shrink-0">
      <Frame94 />
      <Frame96 />
      <Frame99 />
      <Frame101 />
    ...
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[55px] items-center pl-[10px] pr-0 py-0 relative size-full">
          <div className="flex items-center justify-center relative shrink-0 size-[268.874px]" style={{ "--transform-inner-width": "268.859375", "--transform-inner-height": "268.859375" } as React.CSSProperties}>
...
function Frame133() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[10px] items-center left-[312px] overflow-clip rounded-[20px] top-[142px] w-[1104px]">
...
function LinearMoneySafe() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Money / Safe 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_15294)" id="Linear / Money / Safe 2">
...
function LinearMessagesConversationPlain() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Messages, Conversation / Plain 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_15416)" id="Linear / Messages, Conversation / Plain 2">
...
function LinearEssentionalUiHome() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Essentional, UI / Home">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_15430)" id="Linear / Essentional, UI / Home">
...
function LinearUsersUserCircle() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Users / User Circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_15257)" id="Linear / Users / User Circle">
...
function LinearUsersUserCircle1() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Users / User Circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_15305)" id="Linear / Users / User Circle">
          <circle cx="8" cy="6" id="Vector" r="2" stroke="var(--stroke-0, black)" />
          <circle cx="8" cy="8" id="Vector_2" r="6.66667" stroke="var(--stroke-0, black)" />
          <path d={svgPaths.p2f515480} id="Vector_3" stroke="var(--stroke-0, black)" strokeLinecap="round" />
        </g>
...
function LinearBusinessStatisticChartSquare() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Business, Statistic / Chart Square">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_15124)" id="Linear / Business, Statistic / Chart Square">
          <path d={svgPaths.p13370480} id="Vector" stroke="var(--stroke-0, black)" />
...
function LinearBusinessStatisticChart() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Business, Statistic / Chart">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_15107)" id="Linear / Business, Statistic / Chart">
...
function LinearMoneyMoneyBag() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Money / Money Bag">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_15184)" id="Linear / Money / Money Bag">
...
function LinearTextFormattingEraserSquare() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Text Formatting / Eraser Square">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_15071)" id="Linear / Text Formatting / Eraser Square">
...
function LinearMapLocationGps() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Map & Location / GPS">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_15039)" id="Linear / Map & Location / GPS">
...
function LinearEssentionalUiBoxMinimalistic() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Essentional, UI / Box Minimalistic">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_15231)" id="Linear / Essentional, UI / Box Minimalistic">
...
function LinearFilesFileCheck() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Files / File Check">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_15273)" id="Linear / Files / File Check">
...
function LinearFilesFileText() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Files / File Text">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_15193)" id="Linear / Files / File Text">
          <path d={svgPaths.pc731100} fill="var(--stroke-0, black)" id="Vector" />
...
function OutlineUsersUserCircle() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Outline / Users / User Circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_15161)" id="Outline / Users / User Circle">
          <g id="Vector">
...
function LinearBusinessStatisticChart5() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Business, Statistic / Chart">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_15025)" id="Linear / Business, Statistic / Chart">
          <path d="M14.6667 14.6667H1.33333" id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" />
          <path d={svgPaths.p3ac51b10} id="Vector_2" stroke="var(--stroke-0, black)" />
          <path d={svgPaths.p1a5aa680} id="Vector_3" stroke="var(--stroke-0, black)" />
          <path d={svgPaths.p239cea80} id="Vector_4" stroke="var(--stroke-0, black)" />
...
function LinearHandsHandHeart() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Hands / Hand Heart">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_15016)" id="Linear / Hands / Hand Heart">
...
function White() {
  return (
    <div className="absolute bg-gray-50 box-border content-stretch flex flex-col gap-[16px] bottom-0 items-center left-0 p-[16px] top-[57px] overflow-y-auto" data-name="White">
...
export default function ProjectManagementDashboard() {
  return (
    <div className="bg-white relative shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] size-full" data-name="Project Management Dashboard">
      <Navbar />
      <Frame132 />
      <Frame133 />
      <White />
