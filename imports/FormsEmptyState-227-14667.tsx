import svgPaths from "./svg-tqzeldtsb3";
...
const imgRectangle4 = "https://picsum.photos/seed/1598/800/600";
const imgImage35 = "https://picsum.photos/seed/1628/800/600";

function BreadcrumbContainer() {
  return (
    <div className="content-stretch flex h-[38px] items-center justify-between min-w-[1104px] relative shrink-0 w-[1104px]" data-name="Breadcrumb Container">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[22px] text-nowrap text-slate-900 tracking-[-0.44px] whitespace-pre">Welcome, Akwesi</p>
    </div>
  );
}
...
function Frame84() {
  return (
    <div className="content-stretch flex gap-[9px] items-center relative shrink-0">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[16px] text-nowrap text-slate-600 whitespace-pre">Quick Actions</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Messages, Conversation / Pen 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_227_15028)" id="Linear / Messages, Conversation / Pen 2">
          <path d="M4 22H20" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeWidth="1.2" />
          <path d={svgPaths.p38118900} id="Vector_2" stroke="var(--stroke-0, white)" strokeWidth="1.2" />
        </g>
        <defs>
          <clipPath id="clip0_227_15028">
...
function Btn() {
  return (
    <div className="basis-0 bg-purple-700 grow h-full min-h-px min-w-px relative rounded-[8px] shrink-0" data-name="Btn">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[11px] relative size-full">
          <LinearMessagesConversationPen />
          <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[16px] text-nowrap text-white whitespace-pre">Request Leave</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-2 border-[#c685ff] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_2px_2px_0px_rgba(0,0,0,0.04)]" />
    </div>
  );
}
...
function DropdownButton() {
  return (
    <div className="basis-0 box-border content-stretch flex grow h-full items-center justify-center min-h-px min-w-px overflow-clip relative rounded-[8px] shadow-[0px_2px_8px_0px_rgba(100,116,139,0.1)] shrink-0" data-name="Dropdown Button">
      <Btn />
    </div>
  );
}
...
function ActionButtonsContainer() {
  return (
    <div className="basis-0 content-stretch flex gap-[12px] grow h-[45px] items-center min-h-px min-w-px relative shrink-0" data-name="Action Buttons Container">
      <DropdownButton />
    </div>
  );
}
    ...
    <div className="basis-0 bg-purple-700 grow h-full min-h-px min-w-px relative rounded-[8px] shrink-0" data-name="Btn">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[11px] relative size-full">
          ...
          <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[16px] text-nowrap text-white whitespace-pre">Request Travel Leave</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-2 border-[#c685ff] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_2px_2px_0px_rgba(0,0,0,0.04)]" />
    </div>
...
function LinearArrowsActionUndoLeftRound() {
  return (
    <div className="relative shrink-0 size-[19px]" data-name="Linear / Arrows Action / Undo Left Round">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19 19">
        <g id="Linear / Arrows Action / Undo Left Round">
          <path d={svgPaths.p123234c0} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="basis-0 bg-purple-700 grow h-full min-h-px min-w-px relative rounded-[8px] shrink-0" data-name="Btn">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[11px] relative size-full">
          ...
          <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[16px] text-nowrap text-white whitespace-pre">Request Refund</p>
        </div>
      </div>
    </div>
  );
...
function ActionButtonsContainer2() {
  return (
    <div className="basis-0 content-stretch flex gap-[12px] grow h-[45px] items-center min-h-px min-w-px overflow-clip relative rounded-[8px] shrink-0" data-name="Action Buttons Container">
      <Btn2 />
    </div>
  );
}
...
function Frame110() {
  return (
    <div className="content-stretch flex gap-[16px] items-center min-w-[1104px] relative shrink-0 w-full">
      <Frame131 />
    </div>
  );
}
...
function Frame88() {
  return (
    <div className="content-stretch flex gap-[9px] items-center relative shrink-0">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[16px] text-nowrap text-slate-600 whitespace-pre">Blogs for you</p>
    </div>
  );
}
...
function Frame102() {
  return (
    <div className="content-stretch flex gap-[6px] items-center justify-center relative shrink-0">
      <div className="h-[12.171px] relative shrink-0 w-[50.713px]" data-name="image 3">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[133.56%] left-[-36.01%] max-w-none top-0 w-[215.72%]" src={imgImage3} />
        </div>
      </div>
      <div className="flex flex-row items-center self-stretch">
        <div className="flex h-full items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "12.15625", "--transform-inner-height": "12.15625" } as React.CSSProperties}>
          <div className="flex-none h-full rotate-[90deg]">
            <div className="h-full relative w-[12.171px]">
              <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13 1">
                  <line id="Line 142" stroke="var(--stroke-0, #E2E8F0)" x2="12.1707" y1="0.5" y2="0.5" />
                </svg>
              </div>
            </div>
          </div>
      ...
      <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[10px] text-nowrap text-slate-400 tracking-[-0.2px] whitespace-pre">August 2, 2025</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] items-start px-[7px] py-0 relative w-full">
          <p className="-webkit-box font-['Montserrat:Medium',sans-serif] font-medium leading-[18px] min-w-full overflow-ellipsis overflow-hidden relative shrink-0 text-[12px] text-slate-700 w-[min-content]">The Ghana Export Promotion Authority (GEPA) in collaboration with the Hungary Export Promotion Agency (HEPA) successfully organized a business...</p>
          <Frame102 />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="basis-0 bg-white grow min-h-px min-w-px relative rounded-[12px] shrink-0">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col gap-[12px] items-center p-[12px] relative w-full">
          <div className="h-[120.371px] relative rounded-[7px] shrink-0 w-full" data-name="image 19">
      ...
      <div aria-hidden="true" className="absolute border border-slate-200 border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_4px_12px_0px_rgba(0,0,0,0.03)]" />
    </div>
  );
}
...
function Frame103() {
  return (
    <div className="content-stretch flex gap-[6px] items-center justify-center relative shrink-0">
      <div className="h-[8px] relative shrink-0 w-[64px]" data-name="image 64">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage64} />
      </div>
      <div className="flex flex-row items-center self-stretch">
        <div className="flex h-full items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "12", "--transform-inner-height": "11" } as React.CSSProperties}>
          <div className="flex-none h-full rotate-[90deg]">
            <div className="h-full relative w-[12px]">
              <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 1">
                  <line id="Line 142" stroke="var(--stroke-0, #E2E8F0)" x2="12" y1="0.5" y2="0.5" />
                </svg>
              </div>
            </div>
          </div>
      ...
      <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[10px] text-nowrap text-slate-400 tracking-[-0.2px] whitespace-pre">August 19, 2025</p>
    </div>
  );
}
...
function Frame89() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] items-start px-[7px] py-0 relative w-full">
          <div className="-webkit-box font-['Montserrat:Medium',sans-serif] font-medium leading-[18px] min-w-full overflow-ellipsis overflow-hidden relative shrink-0 text-[12px] text-slate-700 w-[min-content]">
            <p className="mb-0">ACET Doubles Down on SME Growth Push for 2025</p>
            <p>&nbsp;</p>
          </div>
          <Frame103 />
        </div>
...
function Frame82() {
  return (
    <div className="basis-0 bg-white grow min-h-px min-w-px relative rounded-[12px] shrink-0">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col gap-[12px] items-center p-[12px] relative w-full">
          <div className="h-[120.37px] relative rounded-[7px] shrink-0 w-full" data-name="image 23">
            <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-contain pointer-events-none rounded-[7px] size-full" src={imgImage23} />
          </div>
          <Frame89 />
        </div>
      </div>
...
function Frame104() {
  return (
    <div className="content-stretch flex gap-[6px] items-center justify-center relative shrink-0">
      <div className="h-[12.17px] relative shrink-0 w-[28.234px]" data-name="image 65">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage65} />
      </div>
      <div className="flex flex-row items-center self-stretch">
        <div className="flex h-full items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "12.15625", "--transform-inner-height": "12.15625" } as React.CSSProperties}>
          <div className="flex-none h-full rotate-[90deg]">
            <div className="h-full relative w-[12.17px]">
              <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13 1">
                  <line id="Line 142" stroke="var(--stroke-0, #E2E8F0)" x2="12.17" y1="0.5" y2="0.5" />
                </svg>
              </div>
            </div>
          </div>
      ...
      <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[10px] text-nowrap text-slate-400 tracking-[-0.2px] whitespace-pre">June 12, 2025</p>
    </div>
  );
}
...
function Frame90() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] items-start px-[7px] py-0 relative w-full">
          <p className="-webkit-box font-['Montserrat:Medium',sans-serif] font-medium leading-[18px] min-w-full overflow-ellipsis overflow-hidden relative shrink-0 text-[12px] text-slate-700 w-[min-content]">ACET CEO criticises Africa’s disjointed response to global tariff crisis</p>
          <Frame104 />
        </div>
      </div>
    </div>
...
function Frame83() {
  return (
    <div className="basis-0 bg-white grow min-h-px min-w-px relative rounded-[12px] shrink-0">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col gap-[12px] items-center p-[12px] relative w-full">
          <div className="h-[120.37px] relative rounded-[7px] shrink-0 w-full" data-name="image 20">
            <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[7px]">
...
function Frame91() {
  return (
    <div className="content-stretch flex gap-[9px] items-center relative shrink-0">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[16px] text-nowrap text-slate-600 whitespace-pre">Trending News</p>
    </div>
  );
}
...
function Frame92() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[8px] items-start px-[7px] py-0 relative w-full">
          <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[18px] min-w-full relative shrink-0 text-[14px] text-slate-700 w-[min-content]">Cedi Gains Must Drive Industrial Growth – ACET CEO Calls ...</p>
        </div>
      </div>
    </div>
  );
...
function Group() {
  return (
    <div className="absolute contents left-[161.43px] top-[80px]">
      <div className="absolute bg-white h-[23.563px] left-[180.83px] top-[92.44px] w-[21.84px]" />
      <div className="absolute h-[42px] left-[161.43px] top-[80px] w-[60.642px]" data-name="image 32">
...
function Frame106() {
  return (
    <div className="absolute content-stretch flex gap-[6px] items-center left-[24.52px] top-[20px]">
      <p className="[white-space-collapse:collapse] font-['Montserrat:Medium',sans-serif] font-medium h-[18px] leading-[16px] overflow-ellipsis overflow-hidden relative shrink-0 text-[11px] text-nowrap text-white tracking-[-0.22px] w-[329px]">Cedi Gains Must Drive Industrial Growth – ACET CEO Calls ...</p>
    </div>
  );
}
...
function Frame93() {
  return (
    <div className="basis-0 bg-white grow min-h-px min-w-px relative rounded-[12px] self-stretch shrink-0">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col gap-[12px] items-center p-[12px] relative size-full">
          <div className="h-[178px] relative rounded-[7px] shrink-0 w-full" data-name="image 19">
            <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[7px]">
              <img alt="" className="absolute max-w-none object-50%-50% object-cover rounded-[7px] size-full" src={imgImage21} />
...
function Frame107() {
  return (
    <div className="absolute content-stretch flex gap-[6px] items-center left-[25.02px] top-[20px]">
      <p className="[white-space-collapse:collapse] font-['Montserrat:Medium',sans-serif] font-medium h-[18px] leading-[16px] overflow-ellipsis overflow-hidden relative shrink-0 text-[11px] text-nowrap text-white tracking-[-0.22px] w-[330px]">{`Ghana's economic growth stalled by lack of focus – ACET `}</p>
    </div>
  );
}
...
function Frame94() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[8px] items-start px-[7px] py-0 relative w-full">
          <p className="-webkit-box font-['Montserrat:Medium',sans-serif] font-medium leading-[18px] min-w-full overflow-ellipsis overflow-hidden relative shrink-0 text-[14px] text-slate-700 w-[min-content]">{`Ghana's economic growth stalled by lack of focus – ACET `}</p>
        </div>
      </div>
    </div>
  );
...
function Group1() {
  return (
    <div className="absolute contents left-[161.93px] top-[80px]">
      <div className="absolute bg-white h-[23.563px] left-[181.33px] top-[92.44px] w-[21.84px]" />
      <div className="absolute h-[42px] left-[161.93px] top-[80px] w-[60.642px]" data-name="image 32">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage32} />
      </div>
    </div>
  );
...
function Frame95() {
  return (
    <div className="basis-0 bg-white grow min-h-px min-w-px relative rounded-[12px] self-stretch shrink-0">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col gap-[12px] items-center p-[12px] relative size-full">
          <div className="h-[178px] relative rounded-[7px] shrink-0 w-full" data-name="image 23">
            <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[7px]">
              <img alt="" className="absolute max-w-none object-50%-50% object-cover rounded-[7px] size-full" src={imgImage24} />
              <div className="absolute bg-[rgba(0,0,0,0.3)] inset-0 rounded-[7px]" />
            </div>
          </div>
          <Frame107 />
...
function Frame108() {
  return (
    <div className="content-stretch flex flex-col gap-[45px] items-start relative shrink-0 w-[783px]">
      <Frame87 />
      <Frame101 />
    </div>
  );
...
function Frame97() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[8px] items-start px-[7px] py-0 relative w-full">
          <p className="-webkit-box font-['Montserrat:Medium',sans-serif] font-medium leading-[17px] min-w-full overflow-ellipsis overflow-hidden relative shrink-0 text-[12px] text-slate-900 tracking-[-0.12px] w-[min-content]">You can now use MTN mobile money app to pay your bills. Download it today for 500mb free data</p>
        </div>
      </div>
    </div>
  );
...
function Frame98() {
  return (
    <div className="bg-white relative rounded-[12px] shrink-0 w-full">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col gap-[12px] items-center p-[12px] relative w-full">
          <div className="h-[132.37px] relative rounded-[7px] shrink-0 w-full" data-name="image">
            <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[7px]">
...
function Frame99() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[8px] items-start px-[7px] py-0 relative w-full">
          <p className="-webkit-box font-['Montserrat:Medium',sans-serif] font-medium leading-[15px] min-w-full overflow-ellipsis overflow-hidden relative shrink-0 text-[12px] text-slate-900 tracking-[-0.24px] w-[min-content]">Inside MAGGI Cube: What Goes In? | MAGGI</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-white relative rounded-[12px] shrink-0 w-full">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col gap-[12px] items-center p-[12px] relative w-full">
          <div className="h-[132.37px] relative rounded-[7px] shrink-0 w-full" data-name="image">
            <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[7px] size-full" src={imgImage1} />
          </div>
          <Frame99 />
        </div>
      </div>
...
function Frame105() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[16px] text-slate-600 w-full">Ads</p>
      <Frame132 />
    </div>
  );
}
...
function Frame109() {
  return (
    <div className="content-stretch flex flex-col h-[478px] items-start overflow-x-clip overflow-y-auto relative shrink-0 w-[282px]">
      <Frame105 />
    </div>
  );
}
...
function Frame129() {
  return (
    <div className="content-stretch flex gap-[38px] items-start relative shrink-0">
      <Frame108 />
      <Frame109 />
    </div>
  );
...
function LinearMoneySafe() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Money / Safe 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_227_15006)" id="Linear / Money / Safe 2">
...
function LinearMessagesConversationPlain() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Messages, Conversation / Plain 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_227_15032)" id="Linear / Messages, Conversation / Plain 2">
...
function BoldEssentionalUiHome() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Bold / Essentional, UI / Home">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Bold / Essentional, UI / Home">
          <path clipRule="evenodd" d={svgPaths.p318fd700} fill="var(--fill-0, #3B82F6)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame18() {
  return (
    <div className="basis-0 content-stretch flex gap-[10px] grow items-center min-h-px min-w-px relative shrink-0">
      ...
      <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[14px] text-blue-500 text-nowrap whitespace-pre">Home</p>
    </div>
  );
}
...
function LinearUsersUserCircle() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Users / User Circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_227_14866)" id="Linear / Users / User Circle">
...
function LinearArrowsActionUndoLeftRound1() {
  return (
...
function Frame23() {
  return (
    <div className="basis-0 content-stretch flex gap-[10px] grow items-center min-h-px min-w-px relative shrink-0">
      <LinearArrowsActionUndoLeftRound1 />
...
function LinearMessagesConversationPen2() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Messages, Conversation / Pen 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
...
function Frame26() {
  return (
    <div className="basis-0 content-stretch flex gap-[10px] grow items-center min-h-px min-w-px relative shrink-0">
      <LinearMessagesConversationPen2 />
...
function LinearUsersUserCircle1() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Users / User Circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_227_14788)" id="Linear / Users / User Circle">
          <circle cx="8" cy="6" id="Vector" r="2" stroke="var(--stroke-0, black)" />
          <circle cx="8" cy="8" id="Vector_2" r="6.66667" stroke="var(--stroke-0, black)" />
          <path d={svgPaths.p2f515480} id="Vector_3" stroke="var(--stroke-0, black)" strokeLinecap="round" />
        </g>
        <defs>
          <clipPath id="clip0_227_14788">
            <rect fill="white" height="16" width="16" />
          </clipPath>
        </defs>
      </svg>
...
function LinearBusinessStatisticChartSquare() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Business, Statistic / Chart Square">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_227_14981)" id="Linear / Business, Statistic / Chart Square">
          <path d={svgPaths.p13370480} id="Vector" stroke="var(--stroke-0, black)" />
...
function LinearBusinessStatisticChart() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Business, Statistic / Chart">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_227_14848)" id="Linear / Business, Statistic / Chart">
...
function LinearMoneyMoneyBag() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Money / Money Bag">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_227_14752)" id="Linear / Money / Money Bag">
    ...
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Notes / Documents Minimalistic">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Linear / Notes / Documents Minimalistic">
          <g clipPath="url(#clip0_227_14724)">
...
function LinearMessagesConversationPen3() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Messages, Conversation / Pen 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Linear / Messages, Conversation / Pen 2">
...
function Frame45() {
  return (
    <div className="basis-0 content-stretch flex gap-[10px] grow items-center min-h-px min-w-px relative shrink-0">
      <LinearMessagesConversationPen3 />
...
function LinearMapLocationGps() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Map & Location / GPS">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_227_14706)" id="Linear / Map & Location / GPS">
...
function LinearEssentionalUiBoxMinimalistic() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Essentional, UI / Box Minimalistic">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_227_15046)" id="Linear / Essentional, UI / Box Minimalistic">
...
function LinearFilesFileCheck() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Files / File Check">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_227_14683)" id="Linear / Files / File Check">
...
function LinearFilesFileText() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Files / File Text">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_227_14874)" id="Linear / Files / File Text">
          <path d={svgPaths.pc731100} fill="var(--stroke-0, black)" id="Vector" />
    ...
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Design, Tools / Ruler Pen">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Linear / Design, Tools / Ruler Pen">
          <g clipPath="url(#clip0_227_14675)">
...
function OutlineUsersUserCircle() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Outline / Users / User Circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_227_15063)" id="Outline / Users / User Circle">
          <g id="Vector">
...
function LinearBusinessStatisticChart5() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Business, Statistic / Chart">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_227_14883)" id="Linear / Business, Statistic / Chart">
          <path d="M14.6667 14.6667H1.33333" id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" />
          <path d={svgPaths.p3ac51b10} id="Vector_2" stroke="var(--stroke-0, black)" />
          <path d={svgPaths.p1a5aa680} id="Vector_3" stroke="var(--stroke-0, black)" />
          <path d={svgPaths.p239cea80} id="Vector_4" stroke="var(--stroke-0, black)" />
...
function LinearHandsHandHeart() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Hands / Hand Heart">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_227_15019)" id="Linear / Hands / Hand Heart">
...
function White() {
  return (
    <div className="absolute bg-gray-50 box-border content-stretch flex flex-col gap-[16px] h-[2640px] items-center left-0 p-[16px] top-[57px]" data-name="White">
