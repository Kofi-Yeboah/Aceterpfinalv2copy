...
function BreadcrumbContainer() {
  return (
    <div className="content-stretch flex h-[38px] items-center justify-between min-w-[1104px] relative shrink-0 w-[1104px]" data-name="Breadcrumb Container">
      <p className="font-semibold leading-[28px] relative shrink-0 text-[22px] text-nowrap text-slate-900 tracking-[-0.44px] whitespace-pre">Welcome, Akwesi</p>
    </div>
  );
}
...
function Frame84() {
  return (
    <div className="content-stretch flex gap-[9px] items-center relative shrink-0">
      <p className="font-semibold leading-[28px] relative shrink-0 text-[16px] text-nowrap text-slate-600 whitespace-pre">Quick Actions</p>
    </div>
  );
}
    ...
    <div className="basis-0 bg-purple-700 grow h-full min-h-px min-w-px relative rounded-[8px] shrink-0" data-name="Btn">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[11px] relative size-full">
          ...
          <p className="font-semibold leading-[normal] relative shrink-0 text-[16px] text-nowrap text-white whitespace-pre">Request Leave</p>
        </div>
      </div>
    ...
    <div className="basis-0 bg-purple-700 grow h-full min-h-px min-w-px relative rounded-[8px] shrink-0" data-name="Btn">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[11px] relative size-full">
          ...
          <p className="font-semibold leading-[normal] relative shrink-0 text-[16px] text-nowrap text-white whitespace-pre">Request Travel Leave</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-2 border-[#c685ff] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_2px_2px_0px_rgba(0,0,0,0.04)]" />
    </div>
    ...
    <div className="basis-0 bg-purple-700 grow h-full min-h-px min-w-px relative rounded-[8px] shrink-0" data-name="Btn">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[11px] relative size-full">
          ...
          <p className="font-semibold leading-[normal] relative shrink-0 text-[16px] text-nowrap text-white whitespace-pre">Request Refund</p>
        </div>
      </div>
    </div>
  );
...
function Frame88() {
  return (
    <div className="content-stretch flex gap-[9px] items-center relative shrink-0">
      <p className="font-semibold leading-[28px] relative shrink-0 text-[16px] text-nowrap text-slate-600 whitespace-pre">Blogs for you</p>
    </div>
  );
}
...
function Frame102() {
  return (
    <div className="content-stretch flex gap-[6px] items-center justify-center relative shrink-0">
      ...
      <p className="font-medium leading-[normal] relative shrink-0 text-[10px] text-nowrap text-slate-400 tracking-[-0.2px] whitespace-pre">August 2, 2025</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] items-start px-[7px] py-0 relative w-full">
          <p className="-webkit-box font-medium leading-[18px] min-w-full overflow-ellipsis overflow-hidden relative shrink-0 text-[12px] text-slate-700 w-[min-content]">The Ghana Export Promotion Authority (GEPA) in collaboration with the Hungary Export Promotion Agency (HEPA) successfully organized a business...</p>
          <Frame102 />
        </div>
      </div>
    </div>
...
function Frame103() {
  return (
    <div className="content-stretch flex gap-[6px] items-center justify-center relative shrink-0">
      ...
      <p className="font-medium leading-[normal] relative shrink-0 text-[10px] text-nowrap text-slate-400 tracking-[-0.2px] whitespace-pre">August 19, 2025</p>
    </div>
  );
}
...
function Frame89() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] items-start px-[7px] py-0 relative w-full">
          <div className="-webkit-box font-medium leading-[18px] min-w-full overflow-ellipsis overflow-hidden relative shrink-0 text-[12px] text-slate-700 w-[min-content]">
...
function Frame104() {
  return (
    <div className="content-stretch flex gap-[6px] items-center justify-center relative shrink-0">
      ...
      <p className="font-medium leading-[normal] relative shrink-0 text-[10px] text-nowrap text-slate-400 tracking-[-0.2px] whitespace-pre">June 12, 2025</p>
    </div>
  );
}
...
function Frame90() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] items-start px-[7px] py-0 relative w-full">
          <p className="-webkit-box font-medium leading-[18px] min-w-full overflow-ellipsis overflow-hidden relative shrink-0 text-[12px] text-slate-700 w-[min-content]">ACET CEO criticises Africa’s disjointed response to global tariff crisis</p>
          <Frame104 />
        </div>
      </div>
    </div>
...
function Frame91() {
  return (
    <div className="content-stretch flex gap-[9px] items-center relative shrink-0">
      <p className="font-semibold leading-[28px] relative shrink-0 text-[16px] text-nowrap text-slate-600 whitespace-pre">Trending News</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[8px] items-start px-[7px] py-0 relative w-full">
          <p className="font-medium leading-[18px] min-w-full relative shrink-0 text-[14px] text-slate-700 w-[min-content]">Cedi Gains Must Drive Industrial Growth – ACET CEO Calls ...</p>
        </div>
      </div>
    </div>
  );
...
function Frame106() {
  return (
    <div className="absolute content-stretch flex gap-[6px] items-center left-[24.52px] top-[20px]">
      <p className="[white-space-collapse:collapse] font-medium h-[18px] leading-[16px] overflow-ellipsis overflow-hidden relative shrink-0 text-[11px] text-nowrap text-white tracking-[-0.22px] w-[329px]">Cedi Gains Must Drive Industrial Growth – ACET CEO Calls ...</p>
    </div>
  );
}
...
function Frame107() {
  return (
    <div className="absolute content-stretch flex gap-[6px] items-center left-[25.02px] top-[20px]">
      <p className="[white-space-collapse:collapse] font-medium h-[18px] leading-[16px] overflow-ellipsis overflow-hidden relative shrink-0 text-[11px] text-nowrap text-white tracking-[-0.22px] w-[330px]">{`Ghana's economic growth stalled by lack of focus – ACET `}</p>
    </div>
  );
}
...
function Frame94() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[8px] items-start px-[7px] py-0 relative w-full">
          <p className="-webkit-box font-medium leading-[18px] min-w-full overflow-ellipsis overflow-hidden relative shrink-0 text-[14px] text-slate-700 w-[min-content]">{`Ghana's economic growth stalled by lack of focus – ACET `}</p>
        </div>
      </div>
    </div>
  );
...
function Frame97() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[8px] items-start px-[7px] py-0 relative w-full">
          <p className="-webkit-box font-medium leading-[17px] min-w-full overflow-ellipsis overflow-hidden relative shrink-0 text-[12px] text-slate-900 tracking-[-0.12px] w-[min-content]">You can now use MTN mobile money app to pay your bills. Download it today for 500mb free data</p>
        </div>
      </div>
    </div>
  );
...
function Frame99() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[8px] items-start px-[7px] py-0 relative w-full">
          <p className="-webkit-box font-medium leading-[15px] min-w-full overflow-ellipsis overflow-hidden relative shrink-0 text-[12px] text-slate-900 tracking-[-0.24px] w-[min-content]">Inside MAGGI Cube: What Goes In? | MAGGI</p>
        </div>
      </div>
    </div>
  );
...
function Frame105() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
      <p className="font-semibold leading-[28px] relative shrink-0 text-[16px] text-slate-600 w-full">Ads</p>
      <Frame132 />
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="basis-0 content-stretch flex gap-[10px] grow items-center min-h-px min-w-px relative shrink-0">
      ...
      <p className="font-medium leading-[normal] relative shrink-0 text-[14px] text-blue-500 text-nowrap whitespace-pre">Home</p>
    </div>
  );
}
