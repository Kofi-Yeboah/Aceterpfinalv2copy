import svgPaths from "./svg-vq01ctof4d";
const imgAvatar = "https://picsum.photos/seed/2217/800/600";
const imgAvatar1 = "https://picsum.photos/seed/1389/800/600";
const imgRectangle4 = "https://picsum.photos/seed/1445/800/600";
const imgImage35 = "https://picsum.photos/seed/1475/800/600";
...
function Frame115() {
  return (
    <div className="bg-white box-border content-stretch flex h-[38px] items-center justify-between px-[16px] py-[11px] relative rounded-[8px] shrink-0 w-[250px]">
    ...
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Arrows Action / Export">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Linear / Arrows Action / Export">
          <g clipPath="url(#clip0_218_20098)">
      ...
      <div className="absolute bottom-[-41.25%] left-0 right-[-42.19%] top-0">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 23 23">
          <g id="Linear / Weather / Cloud Upload">
            ...
            <path d={svgPaths.p3f7e6190} id="Vector_2" stroke="var(--stroke-0, #7E22CE)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          </g>
        </svg>
      </div>
    </div>
...
function Frame7() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
      <p className="font-normal leading-[normal] relative shrink-0 text-[14px] text-nowrap text-slate-900 whitespace-pre">{`All  Roles`}</p>
    </div>
  );
}
...
function Frame114() {
  return (
    <div className="absolute content-stretch flex items-center justify-between right-[24px] top-[135px] w-[1104px]">
      <Frame115 />
      <Frame118 />
    </div>
  );
  ...
  return (
    <div className="bg-blue-800 relative shrink-0 w-full" data-name="Table cell heading">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex items-center justify-between px-[16px] py-[10px] relative w-full">
          <p className="basis-0 font-semibold grow leading-[normal] min-h-px min-w-px relative shrink-0 text-[12px] text-white">Name</p>
        </div>
      </div>
    </div>
  );
...
function Frame24() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center relative shrink-0 text-[12px] text-nowrap whitespace-pre">
      <p className="font-medium leading-[normal] relative shrink-0 text-black">David Bannerman</p>
      <p className="font-normal leading-none relative shrink-0 text-slate-600">Johnydee@acme.com</p>
    </div>
  );
}
...
function Avatar1() {
  return (
    <div className="relative rounded-[200px] shrink-0 size-[32px]" data-name="Avatar">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[200px] size-full" src={imgAvatar1} />
    </div>
  );
}
...
function Frame25() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center relative shrink-0 text-[12px] text-nowrap whitespace-pre">
      <p className="font-medium leading-[normal] relative shrink-0 text-black">{`Joyce Blessing `}</p>
      <p className="font-normal leading-none relative shrink-0 text-slate-600">Johnydee@acme.com</p>
    </div>
  );
}
...
function Frame22() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      <p className="font-medium leading-[normal] relative shrink-0 text-[12px] text-nowrap text-white whitespace-pre">Role</p>
    </div>
  );
}

function Frame23() {
  return <div className="content-stretch flex items-center justify-between shrink-0 w-[16px]" />;
}
...
function Frame26() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center relative shrink-0">
      <p className="font-normal leading-none relative shrink-0 text-[12px] text-nowrap text-slate-500 whitespace-pre">Administrator</p>
    </div>
  );
}
...
function Frame27() {
  return (
    <div className="bg-red-50 box-border content-stretch flex flex-col gap-[4px] items-start justify-center overflow-clip px-[8px] py-[4px] relative rounded-[12px] shrink-0">
      <p className="font-normal leading-none relative shrink-0 text-[12px] text-nowrap text-red-600 whitespace-pre">Inactive</p>
    </div>
  );
}
...
function Frame29() {
  return (
    <div className="bg-green-50 box-border content-stretch flex flex-col gap-[4px] items-start justify-center overflow-clip px-[8px] py-[4px] relative rounded-[12px] shrink-0">
      <p className="font-normal leading-none relative shrink-0 text-[12px] text-green-600 text-nowrap whitespace-pre">Active</p>
    </div>
  );
}
...
function Frame116() {
  return (
    <div className="absolute content-stretch flex items-center left-[312px] overflow-clip top-[194px] w-[1104px]">
      <Frame34 />
      <Frame33 />
      <Frame36 />
      <Frame35 />
...
function Btn() {
  return (
    <div className="bg-white box-border content-stretch flex gap-[8px] h-[38px] items-center justify-center px-[16px] py-[11px] relative rounded-[8px] shrink-0" data-name="Btn">
      <div aria-hidden="true" className="absolute border border-slate-200 border-solid inset-[-1px] pointer-events-none rounded-[9px] shadow-[0px_2px_2px_0px_rgba(0,0,0,0.04)]" />
      <p className="font-medium leading-[normal] relative shrink-0 text-[14px] text-nowrap text-slate-700 whitespace-pre">View roles</p>
    </div>
  );
}
...
function Btn1() {
  return (
    <div className="bg-purple-700 box-border content-stretch flex gap-[8px] h-[38px] items-center justify-center px-[16px] py-[11px] relative shadow-[0px_2px_2px_0px_rgba(0,0,0,0.04)] shrink-0" data-name="Btn">
      ...
      <p className="font-semibold leading-[normal] relative shrink-0 text-[14px] text-nowrap text-white whitespace-pre">Add new</p>
    </div>
  );
}
...
function Frame112() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-center right-[23px] top-[78px]">
      <Btn />
    ...
    <div className="relative shrink-0 size-[16px]" data-name="Bold Duotone / Users / User">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Bold Duotone / Users / User">
          <ellipse cx="8" cy="4" fill="var(--fill-0, #3B82F6)" id="Vector" rx="2.66667" ry="2.66667" />
...
function LinearMoneySafe() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Money / Safe 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_218_19749)" id="Linear / Money / Safe 2">
...
function LinearMessagesConversationPlain() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Messages, Conversation / Plain 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_218_20026)" id="Linear / Messages, Conversation / Plain 2">
...
function LinearEssentionalUiHome() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Essentional, UI / Home">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_218_20130)" id="Linear / Essentional, UI / Home">
...
function LinearUsersUserCircle() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Users / User Circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_218_20093)" id="Linear / Users / User Circle">
...
function LinearBusinessStatisticChartSquare() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Business, Statistic / Chart Square">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_218_20037)" id="Linear / Business, Statistic / Chart Square">
          <path d={svgPaths.p13370480} id="Vector" stroke="var(--stroke-0, black)" />
...
function LinearMoneyMoneyBag() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Money / Money Bag">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_218_19833)" id="Linear / Money / Money Bag">
    ...
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Notes / Documents Minimalistic">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Linear / Notes / Documents Minimalistic">
          <g clipPath="url(#clip0_218_19825)">
...
function LinearFilesFileCheck() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Files / File Check">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_218_19961)" id="Linear / Files / File Check">
...
function LinearFilesFileText() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Files / File Text">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_218_19792)" id="Linear / Files / File Text">
          <path d={svgPaths.pc731100} fill="var(--stroke-0, black)" id="Vector" />
    ...
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Design, Tools / Ruler Pen">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Linear / Design, Tools / Ruler Pen">
          <g clipPath="url(#clip0_218_19771)">
...
function OutlineUsersUserCircle() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Outline / Users / User Circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_218_19884)" id="Outline / Users / User Circle">
          <g id="Vector">
...
function LinearBusinessStatisticChart5() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Business, Statistic / Chart">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_218_19776)" id="Linear / Business, Statistic / Chart">
          <path d="M14.6667 14.6667H1.33333" id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" />
          <path d={svgPaths.p3ac51b10} id="Vector_2" stroke="var(--stroke-0, black)" />
          <path d={svgPaths.p1a5aa680} id="Vector_3" stroke="var(--stroke-0, black)" />
          <path d={svgPaths.p239cea80} id="Vector_4" stroke="var(--stroke-0, black)" />
...
function LinearHandsHandHeart() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Linear / Hands / Hand Heart">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_218_19744)" id="Linear / Hands / Hand Heart">
...
export default function FormsEmptyState() {
  return (
    <div className="bg-white relative size-full" data-name="Forms - empty state">
      <Navbar />
      <p className="absolute font-semibold leading-[28px] left-[312px] text-[22px] text-nowrap text-slate-900 top-[83px] tracking-[-0.44px] whitespace-pre">User management</p>
      <Frame114 />
      <Frame116 />
      <Frame112 />
      <Frame37 />
