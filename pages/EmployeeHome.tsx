...
import { CalendarOff, Plane, ReceiptText, X, Calendar, ArrowRight, Clock } from "lucide-react";
...
export function EmployeeHome({ onNavigate }: { onNavigate?: (navKey: string) => void }) {
      ...
      <div className="max-w-[1104px] mx-auto px-6 py-8">
        ...
        <div className="mb-11">
          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            {/* Timesheet */}
            <button onClick={() => onNavigate?.("EMPLOYEE SELF-SERVICE-Employee Timesheet")} className="group relative bg-white rounded-[12px] border border-slate-200 px-5 py-5 flex items-center gap-4 shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)] hover:border-purple-300 hover:shadow-[0px_4px_16px_0px_rgba(124,58,237,0.1)] transition-all duration-200 text-left">
              <div className="w-11 h-11 rounded-[10px] bg-amber-50 group-hover:bg-amber-100 flex items-center justify-center flex-shrink-0 transition-colors">
